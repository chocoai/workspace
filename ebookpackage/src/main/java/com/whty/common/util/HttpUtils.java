...
public class HttpUtils
{
  ...
  public static String doPost(String url, String value,Map<String,String> header) throws MalformedURLException, IOException
  {
    HttpURLConnection urlconn = null;
    urlconn = (HttpURLConnection)new URL(url).openConnection();
    urlconn.getRequestProperties();
	...
	for (String key : header.keySet()) {
		System.out.println("key= "+ key + " and value= " + header.get(key));
