...
public class ManageWhiteListController extends BaseController {
	...
	@ResponseBody
	public void save(@ModelAttribute("whiteList") WhiteList whiteList, Model model, HttpServletRequest request,
	...
	public String list(HttpServletResponse response, HttpServletRequest request, PageRequest pageRequest, Model model,
		...
		HandlerResult handlerResult = whiteListService.queryWhiteListPage(paramMap, page);
