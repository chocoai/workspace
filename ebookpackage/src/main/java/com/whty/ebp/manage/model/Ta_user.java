...
public class Ta_user implements Serializable {
	...
	private String  status;//0有效，1禁用
	private Integer  login_count;//登录次数
	private Date  use_time;//开始使用时间
	private Date  last_time;//最后使用时间
	private Date  create_time ;//创建时间
	private Date  update_time;//更新时间
	private String  gender;//性别0女1男
	private String  phone_number;//电话号码
	private String  email;//邮箱
	private String  real_name;//真实姓名
	private String  user_type;//用户类型0:学生,1:老师,2:学校管理员,3:机构管理员,4:超级管理员，5:家长
	private String  birthday;//生日
	private String  address;//地址
	private String  area_code;//所属区域编码
	private String  area_name;//所属区域名称
	private String  platform_id;//所属平台id
	
	/*
	 * 非数据库字段
	 */
	private String canUpgrade;//某客户端版本下，能否升级
