...
@Controller
@RequestMapping(value = "/manage/browserWhite")
public class BrowserWhiteListController extends BaseController {
	...
	public void save(@ModelAttribute("browser") Browser browser, Model model, HttpServletRequest request,
		...
		browserService.saveWhite(browser);
	...
	public void delete(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		browserService.deleteWhite(map);
...
//			printJson(response, browserService.queryById(id));
//		} else {
...
//	}
	...
	@ResponseBody
	public void update(@ModelAttribute("browser") Browser browser, Model model, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		browserService.updateWhite(browser);
	...
	public String list(HttpServletResponse response, HttpServletRequest request, PageRequest pageRequest, Model model,
		...
		String version = browserService.queryWhiteVersion();
		page.setPagination(true);
		HandlerResult handlerResult = browserService.queryWhiteListPage(paramMap, page);
		model.addAttribute("version", version);
		model.addAttribute("list", handlerResult.getResultList());
		model.addAttribute("page", page);
		model.addAllAttributes(paramMap);
		page.setPagination(false);
		return "browser/whiteList";
	}
