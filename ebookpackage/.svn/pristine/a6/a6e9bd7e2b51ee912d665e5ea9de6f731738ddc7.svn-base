package com.whty.ebp.base.interceptor;
...
import com.whty.ebp.manage.controller.FrameworkController;
...
public class CommonInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request,    
        ...
        if(sysUser == null){  
             ...
             if ("XMLHttpRequest".equalsIgnoreCase(type)) {//判断Ajax请求
             	response.setHeader("sessionstatus", Constants.MSG_TIME_OUT);
             }else{
