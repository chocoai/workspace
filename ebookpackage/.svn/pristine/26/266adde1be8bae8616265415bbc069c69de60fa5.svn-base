...
import com.whty.page.util.PropertiesUtil;
...
//        if (properties == null) {
//            throw new UnsupportedOperationException("Create config.properties in your classpath and new properties database.vendor ,make the value is mysql or mssql or oracle");
//        }
//        String tempType = properties.getProperty("database.vendor");
//        if (null == tempType) {
//            throw new RuntimeException("Make sure you had a properties named database.vendor in config.properties");
//        } else {
