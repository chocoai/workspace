	...
	var _menus = {
		"menus" : [ {
			...
			"menus" : [ {
				...
				"menuname" : "设备台账",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/device/deviceJsp"
			}, {
				"menuid" : "12",
				"menuname" : "设备运营",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/device/operateJsp"
			}]
		}, {
			"menuid" : "2",
			"icon" : "icon-sys",
			...
			"menus" : [ {
				...
				"menuname" : "电价设置",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/price/priceJsp"
			} ]
		}, {
			"menuid" : "3",
			"icon" : "icon-sys",
			...
			"menus" : [{
				...
				"menuname" : "充电订单",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/order/orderJsp"
			},{
				"menuid" : "32",
				"menuname" : "交易流水",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/trade/tradeJsp"
			},{
				"menuid" : "33",
				"menuname" : "充电历史",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/record/recordJsp"
			} ]
		},{
			"menuid" : "4",
			"icon" : "icon-sys",
			...
			"menus" : [ {
				...
				"menuname" : "使用电量",
				"icon" : "icon-nav",
				"url" : basePath+"ChargePile/power/powerJsp"
			}]
		} ]
	};
