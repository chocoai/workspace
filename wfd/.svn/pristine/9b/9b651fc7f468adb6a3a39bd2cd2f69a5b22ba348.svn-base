...
import com.whty.wfd.common.constants.SysConstants;
import com.whty.wfd.page.dao.BasePropertyDao;
import com.whty.wfd.page.model.BaseProperty;
...
public class BasePropertyServiceImpl implements BasePropertyService {
	 ...
	 * @return
	 */
	public static int generateExpireTime() {
