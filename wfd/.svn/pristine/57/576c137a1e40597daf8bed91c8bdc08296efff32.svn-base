...
<body>
  <div class="page">
    <header class="bar bar-nav bgfff">
      <a class="icon icon-left fl" href="${base}/page/manager/createClass.html?userId=${userId}&classId=${classId}"></a>
  ...
  <script type="text/javascript" src="${base}/js/manager/addStudent.js"></script>
  ...
  var classId = $("#classId").val();
 	...
 	appGoback = function(){
	 	window.location.href="${base}/page/manager/createClass.html?userId=${userId}&classId=${classId}";
	}
 	
 
  	$(document).on('touchend','#cancel',function(){
	 		location.href = "${base}/page/manager/createClass.html?userId=${userId}&classId=${classId}";
 	});
