...
public class HttpUtils {
	...
	public static String addException(HttpServletRequest request, Exception e) {
	 ...
	 * @return
	 */
	public void httpPostSendMqttMessage(String topic, String message) {
		// 创建默认的httpClient实例.
		// String responseResult = null;
		CloseableHttpClient httpclient = HttpClients.createDefault();
		// 创建httppost
		HttpPost httppost = new HttpPost(SysConfigUtils.getStrValue("mqtt.server.sendMessage.api.url"));
		// 创建参数队列
		List<BasicNameValuePair> formparams = new ArrayList<BasicNameValuePair>();
		formparams.add(new BasicNameValuePair("topic", topic));
