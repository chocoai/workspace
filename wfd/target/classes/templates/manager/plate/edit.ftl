...
<body>
  ...
  <div class="page">
    <header class="bar bar-nav zxf_header bgfff">
      <a class="icon icon-left pull-left" href="${base}/page/manager/plate/list.html?userId=${userId}"></a>
      <h1 class="title">${plate.name}</h1>
    ...
    <div class="content zxf_content infinite-scroll" data-distance="100">
      <div class="buttons-tab bgfff zxf_buttons-tab">
        <a href="#tab1" class="tab-link active button">版块老师</a>
        <a href="#tab2" class="tab-link button">关联班级</a>
      </div>
        ...
        <div class="tabs">
          <div id="tab1" class="tab active">
            <div class="zxf_search_box pdlr075 pdtb05 bgfff clearfix fixed">
              ...
              <a href="javascript:;" class="zxf_bg_blueBtn zxf_add_studentBtn fr">添加老师</a>
            </div>
		                ...
		                <div class="zxf_cstuCon bgfff">
		                  <ul class="student_list pdl075">
		                  	<#list aUserList as user>
			                      ...
			                      <a href="javascript:;" id="${user.id}" class="zxf_bor_grayBtn zxf_exitBtn fr mgt04">
			                      <em class="zxf_em">退出版块</em>
			                      </a>
			                    </li>
		                  	</#list>
		                  </ul>
          ...
          <div id="tab2" class="tab bgfff">
            	<div class="zxf_relation_moduleWp mh29 mgt025">   
	                <div class="zxf_relation_moduleList pdb05">
	                    <ul class="">
	                    	<#list classList as class>
	                    	<li class="pdtb06 bb clearfix pdlr075">   
	                    		<#if class.relationStatus ==1 >
                    			 	<a href="javascript:;"  id="${class.id}" class="zxf_relativeBtn on qxgl" name="relative">取消关联</a>         
                    			 <#else>
                    			 	<a href="javascript:;"  id="${class.id}"  class="zxf_relativeBtn gxbj" name="relative">关联</a>         
                    			 </#if>                       
		                        
		                        <div class="zxf_txtBox w70">
		                          <a href="javascript:;" class="txt_ellipsis w100 f085 con onlyCon mgt02">${class.name}</a>
		                        </div>
		                     </li>
		                    </#list>
	                    </ul>
   ...
   <script type="text/javascript" src="${base}/js/manager/plate/edit.js"></script>
    <script>
    $(function() {    
