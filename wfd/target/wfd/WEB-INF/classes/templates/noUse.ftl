...
<div class="page">
    <header class="bar bar-nav zxf_header bgfff"> 
      <a class="icon icon-left pull-left" onclick="getApp()"></a>   
        <h1 class="title">
            微辅导
    ...
    <div class="content bgfff mgt025">                
      <div class="zxf_noCon_wp pdt8 t_c">
        <img src="http://ued.t.huijiaoyun.com/tianyu_edu_dev/touch/weiLesson/images/img_nocon9.png" alt="" class="img_nocon9">
        <p class="mgt075">当前账号尚未开通微辅导哦!</p>
      </div>
    </div>
