...
public class HMACSHA1 {
	...
	static {
		...
		keyMap.put(1, SysConfigUtils.getStrValue("mqtt.server.hmac.key1"));
		keyMap.put(2, SysConfigUtils.getStrValue("mqtt.server.hmac.key2"));
		keyMap.put(3, SysConfigUtils.getStrValue("mqtt.server.hmac.key3"));
		keyMap.put(4, SysConfigUtils.getStrValue("mqtt.server.hmac.key4"));
		keyMap.put(5, SysConfigUtils.getStrValue("mqtt.server.hmac.key5"));
	}
