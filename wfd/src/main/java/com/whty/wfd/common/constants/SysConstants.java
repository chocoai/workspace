...
public final class SysConstants {
	...
	public static final String EXCUTE_TIME_ZONE = "1";

	public static final String DELAY_TIME_TWO_MINUTES = "120";// 2分钟等于120秒

	public static final String DELAY_TIME_FOUR = "40";

	public static String SESSION_USER = "sessionUser";

	public static final String ARCHIVE_NOTE = "收藏";

	public static final String PRODUCT_NAME = "一体机监控";
