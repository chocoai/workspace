...
<body>
  <div class="page">
    <header class="bar bar-nav bgfff">
      <a class="icon icon-left fl" href="${base}/page/manager/plate/create.html?userId=${userId}&plateId=${plateId}"></a>
    ...
    <div class="zxf_creadHead f085 c_norma bb search fixed">
      <div class="zxf_search_box pd1 clearfix bgfff">
        ...
        <a href="javascript:;" class="zxf_bg_blueBtn zxf_add_studentBtn fr mgr075 mgt01 searchTeacherBtn">搜索</a>
      </div>
    </div>
          ...
          <div class="zxf_creatCon pdtb075 c_9f9f9f f085">
            ...
            <div class="zxf_add_studentBox pdtb05">
              <ul class="clearfix">
               	...
               	<#list allTeacherList as teacher>
                     <li class="t_c f085 c_normal">
	                  ...
	                  <p class="txt_ellipsis w90 mgt02" platformCode="${teacher.platformCode}" id="${teacher.personId}">${teacher.name}</p>
	                </li>       
    ...
    <div class="fixed t_c zxf_nav_bottom bt pdtb06 bgfff">
      <ul class="clearfix">
        <li class="fl w50"><a href="javascript:;" class="zxf_bg_grayBtn_normal cancel" id="cancel">取消</a></li>
   ...
   <input type="hidden" name="userId" id="userId" value="${userId}">
    ...
    <script type="text/javascript" src="${base}/js/manager/plate/addTeacher.js"></script>
    ...
    $(function() {    
    	...
    	appGoback = function(){
	 		window.location.href="${base}/page/manager/plate/create.html?userId=${userId}&plateId=${plateId}";
		}
    	...
    	$(document).on('touchend','#cancel',function(){
	 		location.href = "${base}/page/manager/plate/create.html?userId=${userId}&plateId=${plateId}";
 		});
