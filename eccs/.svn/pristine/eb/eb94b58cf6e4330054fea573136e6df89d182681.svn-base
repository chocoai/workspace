              ...
              <div class="list_table stripe" style="width:80%; margin:50px auto; min-width:980px; padding-left:  6em;">
            		<div class="article" style="margin:0; clear:both; width:100%;">
                     ...
                     <div style="clear:both;"></div>
                       <div id="say" readonly="readonly" style="  margin-left:10px;overflow-y:auto; overflow-x:auto;  float:left;line-height:22px; height:550px; width:80%; text-indent:2em; border:1px solid #c1e9ff; margin:6px 20px 0px 20px;background-color:#fff;letter-spacing:2px;">
                     ${notice.content}        
                    </div>
                    <div style="clear:both;"></div>
