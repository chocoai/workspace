...
public class DateUtils {
	 ...
	 * 字符串转日期
	 */
	public static Date stringToDateByPattern(String str, String pattern)
	...
	public static String getPassTime(Date date) throws RuntimeException {
		...
		if (difference < minute) {
			...
			str = difference / minute + "分" + difference % minute / second
					+ "秒前";
	...
	public static String minute2Time(long num) {
		...
		if (difference < hour) {
			...
			String min_val = difference % hour != 0 ? (difference % hour + "分钟")
					: "";
			String hour_val = (difference % day / hour) != 0
					? (difference % day / hour) + "小时" : "";
			...
			String hour_val = (difference % day / hour) != 0
					? (difference % day / hour) + "小时" : "";
			String day_val = (difference % month / day) != 0
					? (difference % month / day) + "天" : "";
			...
			String day_val = (difference % month / day) != 0
					? (difference % month / day) + "天" : "";
			String month_val = (difference % year / month) != 0
					? (difference % year / month) + "月" : "";
	...
	/**
	 * 计算两个日期字符串相隔天数(yyyy-MM-dd)
	 */
	public static int daysBetween1(String sDate, String eDate)
			throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Calendar cal = Calendar.getInstance();
		cal.setTime(sdf.parse(sDate));
	 ...
	 */
	public static int daysBetween2(String sDate, String eDate)
			throws ParseException {
