<html>
	...
	<body link=blue vlink=purple>
        ...
        <tr>
			    ...
			    <td width="34%" style="background:#fff;" align="left"><font size="2">${project.name}</font></td>
			    <td width="16%" class="tab_title" align="right" style="font-weight:bold;" height="30"><font size="2">编制批次</font></td>
			    <td width="35%" style="background:#fff;" align="left">${datestr}</td>
  		</tr>
	    <tr>
			    <td class="tab_title" align="right" style="font-weight:bold;" height="30"><font size="2">委托单位</font></td>
			    <td width="34%" style="background:#fff;" align="left"><font size="2">${project.customer.cusName}</font></td>
			    <td width="16%" class="tab_title" align="right" style="font-weight:bold;" height="30"><font size="2">编审类型</font></td>
			    <td width="35%" style="background:#fff;" align="left"><font size="2">${project.editorialType.name}</font></td>
	   </tr>
	   <tr>
			    <td class="tab_title" align="right"><font size="2" style="font-weight:bold;" height="30">工程编号</font></td>
			    <td width="34%" style="background:#fff;" align="left"><font size="2">${project.no}</font></td>
			    <td width="16%" class="tab_title" align="right" style="font-weight:bold;" height="30"><font size="2">服务类别</font></td>
			    <td width="35%"  style="background:#fff;" align="left"><font size="2">${project.serviceType.name}</font></td>
	  </tr>
	  <tr>
