    ...
    <div id="content">
        ...
        <table border="1" cellspacing="1" cellpadding="1" class="input_table">
            ...
            <tr>
                ...
                <td colspan="8">
                    <textarea rows="4" maxlength="120" style="width:100%;margin-top:10px;margin-bottom:0px;resize:none" name="summary.summary" readonly="readonly">${summary.summary}</textarea>
                </td>
            </tr>
            <tr>
                <td width="10%" class="tab_title">完善措施</td>
                <td colspan="8">
                    <textarea rows="4" maxlength="120" style="width:100%;margin-top:10px;margin-bottom:0px;resize:none" name="summary.perfectMeasures" readonly="readonly">${summary.perfectMeasures}</textarea>
                </td>
            </tr>
            <tr>
                <td width="10%" class="tab_title">归档情况</td>
                <td colspan="8">
                    <textarea rows="4" maxlength="120" style="width:100%;margin-top:10px;margin-bottom:0px;resize:none" name="summary.archiveSituation" readonly="readonly">${summary.archiveSituation}</textarea>
                </td>
            </tr>
            <tr>
                <td width="10%" class="tab_title">其他</td>
                <td colspan="8">
                    <textarea rows="4" maxlength="120" style="width:100%;margin-top:10px;margin-bottom:0px;resize:none" name="summary.other" readonly="readonly">${summary.other}</textarea>
                </td>
            </tr>
        </table>
    </div>
