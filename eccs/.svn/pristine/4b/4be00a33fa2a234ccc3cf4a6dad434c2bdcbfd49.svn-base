...
<a href="javascript:window.location.reload();">审核列表</a>
</div>
    <div id="content">
        ...
        <#list pageBean.list as step8>     
                   <tr>
	                     ...
	                     <td style=" text-align:center;">
			                     <a href="/step8/edit.htm?step8.id=${step8.id}" title="编辑">编辑</a>
			                     <a href="/step8/show.htm?step8.id=${step8.id}" title="查看">查看</a>
	                     </td>                             
				</tr>
   				</#list>
   				<#else>
