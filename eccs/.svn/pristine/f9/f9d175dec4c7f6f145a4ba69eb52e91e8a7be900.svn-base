...
<script >
  ...
  function ajaxFileUpload(filediv,annexTypeId,desc,fileNum,fileOwner,filePage) {
      ...
      (
          {
              url: '/step1/uploadFile.htm?project.id='+${projectId}+'&annexTypeId='+annexTypeId  //用于文件上传的服务器端请求地址
        ...
        <div id="content">
              <div align="center" class="list_table stripe" style="width:80%; margin:20px auto; min-width:650px;">
            		<div class="article" style="margin:0; clear:both; width:90%">
                     ...
                     <input type="button"  onclick="uploaFile();"  value="上传" style="float: left; width:80px; height:30px; text-align:center; line-height:30px; color:#fff; background-color:#01749e; margin-top:10px; margin-bottom:10px; margin-left:0px; font-family:"新宋体";"/>
                     </div>
                    </div>
             </div>
              <div style="clear:both;"></div>                    
