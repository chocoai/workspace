...
<form action="/bid/uploadFile.htm" method="post" id="uploadForm" enctype="multipart/form-data">
        <div id="content">
...
<script >
  ...
  function ajaxFileUpload(filediv,annexTypeId,desc,fileNum,fileOwner,filePage) {
      ...
      (
          {
              url: '/bid/uploadBidSummaryFile.htm?bidSummary.id='+${bidSummaryId}+'&annexTypeId='+annexTypeId
