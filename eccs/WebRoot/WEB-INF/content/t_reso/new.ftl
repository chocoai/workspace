...
<a href="#">信息登记-<#if t_hremployee.id==null>新增<#else>编辑</#if></a>
</div>
 <!--<form action="/t_liborrow/save.htm" method="post" id="contractForm">  -->
    ...
    <div id="content">
        ...
        <table border="1" cellspacing="1" cellpadding="1" class="input_table">
                                       <tr>
                                       <input name="t_hremployee.id" value="${t_hremployee.id}" hidden/>
                                       <input name="t_hrentryrecord.id" value="${t_hrentryrecord.id}" hidden/>
                                        <td width="50" class="tab_title red"><p>姓名</p></td>
                                         <td><input id="yeename" type="text"  class="text_a"  value="${t_hremployee.name}" name="t_hremployee.name"/></td>
                                        <td width="50" class="tab_title red"><p>分配部门</p></td>
                                         <input name="t_hremployee.dept_id.id"  id="senderDeptIdId" type="hidden"  value="${t_hremployee.dept_id.id}" />
                        				<td><input id="takbranch" onclick="getDept()" readonly="true"  type="text"  class="text_a" name="t_hremployee.dept_id.name" value="${t_hremployee.dept_id.name}"/></td>
                                       </tr>
                                       <tr>
                                       <td width="50" class="tab_title red"><p>性别</p></td>
                                         <td>
                                         <select name="t_hremployee.sex" id="projectid" style=" float:left;line-height:22px; width:200px; height:30px; text-indent:6px; border:1px solid #c1e9ff; margin:6px 10px 0px 0px;">
										...
										<option value="2" <#if  t_hremployee.sex==2>selected='selected'</#if> >女</option>
                                         ...
                                         <td width="50" class="tab_title"><p>出生年月</p></td>
                                         <td><input onClick="WdatePicker({maxDate:'{%y-16}-%M-%d'})" value="<#if t_hremployee.birth !="">${t_hremployee.birth?string('yyyy-MM-dd')}</#if>" readonly="true" type="text"  class="text_a"  name="t_hremployee.birth"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title"><p>联系电话</p></td>
                                         <td><input  type="text" id="phones"  class="text_a"  name="t_hremployee.phone" value="${t_hremployee.phone}"/></td>
                                         <td width="50" class="tab_title"><p>专业</p></td>
                                         <td><input  type="text"  class="text_a"  name="t_hremployee.major" value="${t_hremployee.phone}"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title"><p>紧急联系人</p></td>
                                         <td><input  type="text"  class="text_a"  name="t_hremployee.emg_contact" value="${t_hremployee.emg_contact}"/></td>
                                         <td width="50" class="tab_title"><p>电子邮箱</p></td>
                                         <td><input  type="text"  class="text_a" id="emails" name="t_hremployee.email" value="${t_hremployee.email}"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title"><p>身份证</p></td>
                                         <td colspan="4"><input  type="text"  class="text_a" id="id_cards" name="t_hremployee.id_card" value="${t_hremployee.id_card}"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title red"><p>系统账号</p></td>
                                        <input name="t_hremployee.sys_account.id" id="userId4"    value="${t_hremployee.sys_account.id }" type="hidden" class="text_c"/>
                                         <td><input id="yeesys_account" type="text"  class="text_a" onclick="getUser()" readonly="true" name="t_hremployee.sys_account.username" value="${t_hremployee.sys_account.username}"/></td>
                                         <td width="50" class="tab_title"><p>排序号</p></td>
                                         <td><input  type="text"  class="text_a" id="sort_nos"  name="t_hremployee.sort_no" value="${t_hremployee.sort_no}"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title"><p>学历信息</p></td>
                                         <td colspan="4"><div style=" display:block; text-align:right; border:1px solid #dadada; border-bottom:0px" class="add_link" ><a href="javascript:addContact();">新增</a> <a href="javascript:removeContact()">删除</a></div></td>
                                       </tr>
                                       <tr>
										  ...
										  <#list listtion as t_hreducation>
										     <input type="hidden" value=${t_hreducation.id}/>
											  <tr>
											    ...
											    <td style=" text-align:center;background-color:#fff;"><input name="zz" type="checkbox" autocomplete="off" value="${t_hreducation.id}" class="cc" /><input name="t_hreducationid" type="hidden" value=${t_hreducation.id}></td>
											    <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hreducationcollege" onchange="check($(this));" class="text_a" value="${t_hreducation.college }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <!--input type="text" name="t_hreducationeducation"  class="text_a" value="${t_hreducation.education }"/-->
											     ...
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hreducationgdate" onblur="check1($(this));" class="text_agdate ccc" value="<#if t_hreducation.gdate !="">${t_hreducation.gdate?string('yyyy-MM-dd')}</#if>" readonly="true"/></td>
											     </tr>
										  </#list>
                                         </table>
                                         </td>
                                        ...
                                        <tr>
                                        <td width="50" class="tab_title"><p>QQ</p></td>
                                         <td><input type="text"  class="text_a" id="qqs" name="t_hremployee.qq" value="${t_hremployee.qq}"/></td>
                                         <td width="50" class="tab_title"><p>微信</p></td>
                                         <td><input type="text"  class="text_a"  name="t_hremployee.we_chat" value="${t_hremployee.we_chat}"/></td>
                                       </tr>
                                        <tr>
                                        <td width="50" class="tab_title"><p>MSN</p></td>
                                         <td><input  type="text"  id="msns" class="text_a"  name="t_hremployee.msn" value="${t_hremployee.msn}"/></td>
                                         <td width="50" class="tab_title"><p>其它</p></td>
                                         <td><input  type="text"  class="text_a"  name="t_hremployee.other" value="${t_hremployee.other}"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title"><p>备注</p></td>
                                         <td colspan="4"><textarea  style="width:100%;height:80px;" name="t_hremployee.remark" id="detailid">${t_hremployee.remark}</textarea></td>
                                       </tr>
                                       <tr>
                                         <td width="50" class="tab_title red"><p>入职时间</p></td>
                                         <td><input id="yeeedate" onClick="WdatePicker({maxDate:'#F{$dp.$D(\'t_hrentryrecord.labor_date\')||\'%y-%M-%d\'}'})" readonly="true" value="${t_hrentryrecord.edate}" type="text"  class="text_a"  name="t_hrentryrecord.edate"/></td>
                                         <td width="50" class="tab_title red"><p>岗位描述</p></td>
                                         <td><input id="yeepost" type="text"  class="text_a"  name="t_hrentryrecord.post" value="${t_hrentryrecord.post}"/></td>
                                       </tr>
                                       <tr>
                                       <td width="50" class="tab_title"><p>工作性质</p></td>
                                         <td>
                                         <select name="t_hrentryrecord.field"  style=" float:left;line-height:22px; width:200px; height:30px; text-indent:6px; border:1px solid #c1e9ff; margin:6px 10px 0px 0px;">
										<option value="">--请选择--</option>
										...
										<option value="2" <#if  t_hrentryrecord.field==2>selected='selected'</#if> >兼职</option>
                                         ...
                                         <td width="100" class="tab_title"><p>劳动合同截止期</p></td>
                                         <td><input onFocus="WdatePicker({minDate:'#F{$dp.$D(\'yeeedate\')}'})" readonly="true" type="text"  class="text_a" id="t_hrentryrecord.labor_date" name="t_hrentryrecord.labor_date" value="<#if t_hrentryrecord.labor_date !="">${t_hrentryrecord.labor_date?string('yyyy-MM-dd')}</#if>"/></td>
                                       </tr>
                                       <tr>
                                       <td width="100" class="tab_title"><p>社保缴费日期</p></td>
                                         <td><input onClick="WdatePicker({minDate:'#F{$dp.$D(\'yeeedate\')||\'%y-%M-%d\'}',maxDate:'#F{$dp.$D(\'t_hrentryrecord.labor_date\')}'})" readonly="true" type="text"  class="text_a"  name="t_hrentryrecord.ss_date" value="<#if t_hrentryrecord.ss_date !="">${t_hrentryrecord.ss_date?string('yyyy-MM-dd')}</#if>"/></td>
                                       <td width="50" class="tab_title"><p>社保缴费基数</p></td>
                                         <td><input type="text" id="ss_bases"  class="text_a"  name="t_hrentryrecord.ss_base" value="${t_hrentryrecord.ss_base}"/></td>
                                       </tr>
                                       <tr>
                                       <td width="100" class="tab_title"><p>公积金缴费日期</p></td>
                                         <td><input  onClick="WdatePicker({minDate:'#F{$dp.$D(\'yeeedate\')||\'%y-%M-%d\'}',maxDate:'#F{$dp.$D(\'t_hrentryrecord.labor_date\')}'})" readonly="true" type="text"  class="text_a"  name="t_hrentryrecord.af_date" value="<#if t_hrentryrecord.af_date !="">${t_hrentryrecord.af_date?string('yyyy-MM-dd')}</#if>"/></td>
                                       <td width="50" class="tab_title"><p>公积金缴费基数</p></td>
                                         <td><input  type="text"  class="text_a" id="af_bases" name="t_hrentryrecord.af_base" value="${t_hrentryrecord.af_base}"/></td>
                                       </tr>
                                       <tr>
                                        <td width="50" class="tab_title"><p>档案所在地</p></td>
                                         <td colspan="4"><input  type="text"  class="text_a"  name="t_hrentryrecord.archives" value="${t_hrentryrecord.archives}"/></td>
                                       </tr>    
                                       <tr>
										  ...
										  <#list listcate as t_hrcertificate>
										     <input type="hidden" value=${t_hrcertificate.id}/>
											  <tr>
											    ...
											    <td style=" text-align:center;background-color:#fff;"><input name="yy" type="checkbox" autocomplete="off" value="${t_hrcertificate.id}" class="dd" /><input name="t_hrcertificateid" type="hidden" value=${t_hrcertificate.id}></td>
											    <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificatename" onchange="check($(this));" class="text_a" value="${t_hrcertificate.name }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificateno"  class="text_a" value="${t_hrcertificate.no }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificatemajor" onchange="check($(this));" class="text_a" value="${t_hrcertificate.major }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificategrade"  class="text_a" value="${t_hrcertificate.grade }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificateissuing_unit"  class="text_a" value="${t_hrcertificate.issuing_unit }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificateidate"  class="text_a ccc" readonly="true" value="<#if t_hrcertificate.idate !="">${t_hrcertificate.idate?string('yyyy-MM-dd')}</#if>" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificatevalidity_period"  class="text_a" value="${t_hrcertificate.validity_period }" /></td>
											     <td style=" text-align:center;background-color:#fff;"> <input type="text" name="t_hrcertificateremark"  class="text_a" value="${t_hrcertificate.remark }" /></td>
											     </tr>
										  </#list>
                                         </table>
                                       </td>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                        <td style="text-align:center; font-weight:bold; background-color:#d3e0f1; width:42px;">序号</td>
									     <td style="text-align:center; font-weight:bold; background-color:#d3e0f1; width:42px;"><input id="qxcheckbox3"  type="checkbox"/></td>
		...
		$("#contractForm").validate({
			...
			submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
				...
				if($("#papersTableId tr").length>1){
					$(".ac").each(function(){
						if($(this).parent().parent().find('input[name=name]').val().trim()==""){
   				...
   				$(".dd").each(function(){
   					if($(this).parent().parent().find('input[name=t_hrcertificatename]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().append(html);
							ok = false;
						}
						if($(this).parent().parent().find('input[name=t_hrcertificatemajor]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().next().next().append(html);
							ok = false;
						}
				...
				if($("#contactTableId tr").length>1){
					$(".cc").each(function(){
						if($(this).parent().parent().find('input[name=t_hreducationcollege]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().append(html);
							ok = false;
						}
						if($(this).parent().parent().find('select[name=t_hreducationeducation]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().next().append(html);
							ok = false;
						}
						if($(this).parent().parent().find('input[name=t_hreducationgdate]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().next().next().append(html);
							ok = false;
						}
   				...
   				$(".b").each(function(){
   					if($(this).parent().parent().find('input[name=college]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().append(html);
							ok = false;
						}
						if($(this).parent().parent().find('select[name=education]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().next().append(html);
							ok = false;
						}
						if($(this).parent().parent().find('input[name=gdate]').val().trim()==""){
							var html = '<p class="remove red" style="text-align:center;">*必填字段</p>';
							$(this).parent().next().next().next().append(html);
							ok = false;
						}
...
function attachment() {
       ...
       window.open('/t_file/filet_reso.htm','','height=' + iHeight + ',innerHeight=' + iHeight + ',width=' + iWidth + ',innerWidth=' + iWidth + ',top=' + iTop + ',left=' + iLeft + ',status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=0,titlebar=no');
      ...
      if(id!=""){
		...
		$.ajax({
			...
			success:function(d){
				if (d == '1') {
					alert('删除成功');
					$("input[type='checkbox']:unchecked.dd").each(function(i){//删除了包含原始存在的证照时重置序号
						$(this).parent().prev().text(i+1);
			      });
			      j = $("input[type='checkbox']:unchecked.dd").length;
			      $("input[type='checkbox']:unchecked.ac").each(function(i){//删除了包含原始存在的证照时重置序号
						$(this).parent().prev().text(++j);
			      });
					//window.parent.location.reload();
					//location.reload();
      ...
      var url = "/t_reso/deletess.htm?xlid=" + idxl;
		$.ajax({
			...
			success:function(d){
				if (d == '1') {
					alert('删除成功');
					$("input[type='checkbox']:unchecked.cc").each(function(i){//删除了包含原始存在的证照时重置序号
						$(this).parent().prev().text(i+1);
			      });
			      j = $("input[type='checkbox']:unchecked.cc").length;
...
function AddRow()
	...
	if(!$("input[name='validity_period']").eq(i).val().trim().match(/^[1-9]\d*$/) || $("input[name='validity_period']").eq(i).val().trim()>30){
	alert("有效期格式错误(1-30)!");
	ok=false;
	return;
	}
	...
	var phones=$("#phones").val().trim();
	  if(phones!=""){
	  var a=!phones.match(/^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/);
  ...
  var emails=$("#emails").val().trim();
	  if(emails!=""){
		  if(!emails.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/)){
		  alert("电子邮箱格式不正确!");
	ok=false;
	return;
  }
   ...
   var id_cards=$("#id_cards").val().trim();
	  if(id_cards!=""){
		  if(!id_cards.match(/^(\d{6})(18|19|20)?(\d{2})([01]\d)([0123]\d)(\d{3})(\d|X)?$/)){
		  alert("身份证格式不正确!");
	ok=false;
	return;
  }
  ...
  var sort_nos=$("#sort_nos").val().trim();
   ...
   var msns=$("#msns").val().trim();
	  if(msns!=""){
		  if(!msns.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/)){
		  alert("MSN格式不正确!");
	ok=false;
	return;
  }
