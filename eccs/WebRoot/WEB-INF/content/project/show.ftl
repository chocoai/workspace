	...
	<div id="content">
		<table border="1" cellspacing="1" cellpadding="1" class="input_table">
			...
			<tr>
				...
				<td width = "22%" style="background-color:#fff;">${deptNames}</td>	
			</tr>
				<tr>
				<td width = "11%" class="tab_title red"><p>立项人</p></td>
			...
			<tr>
				...
				<td width="" style="background-color:#fff;">${project.createUser.name }</td>
			...
			<tr>
				...
				<td colspan="5" style="background-color: #fff;">${project.projectProfile}</td>
			</tr>
			...
			<tr class = "no-print">
				<td colspan="6" style=" text-align:right;">
					...
					<input type="button" value="打印" class="sub" onclick="javascript:toPrint(${project.id});" />                                          
				</td>
			</tr>                          
		</table>                          
	</div>
