<html>
  ...
  <tr>
	    ...
	    <td align="right" width="92" style="font-weight:bold;"><font size="2" height="30">项目编号</font></td>
	    <td style="background-color:#fff;" align="left" width="300">
  ...
  <tr>
	 ...
	 <table border="1" id="step8ItemId" cellspacing="1" cellpadding="1" style="border-collapse: collapse;border-width:0px; border-style:hidden;" width="100%">
	 	<tr>
	   ...
	   <#if step8ItemList && step8ItemList?size!=0>
			  <#list step8ItemList as step8Item>
			  		<tr>
					    <td height="30" style=" text-align:center;background-color:#fff; word-break: break-all;"><font size="2">${step8Item.content}</td>
					    <td height="30" style=" text-align:center;background-color:#fff;">
							...
							--->
						 	  <#if step8Item.result == 1>修改通过
			                 <#elseif step8Item.result == 2>修改未通过
			                 <#elseif step8Item.result == 0>未修改
			                 </#if> 
						</td>
			  		</tr>
			  </#list>
  ...
  <tr>
          ...
          <td  height="30" style=" background-color:#fff;" align="left"> <font size="2">${step8.validateName}</font></td>
          <td  height="30" class="tab_title" align="right" width="92" style="font-weight:bold;"><font size="2">审核日期</font></td>     
          <td  height="30" style="background-color:#fff;" align="left"> <font size="2">${step8.validateDate}</font></td>       
  </tr>
  <tr>
    		<td colspan="4" style="padding-right: 0px; padding-left: 0px;">
