	...
	<div style="width: 90%; min-width: 980px; margin: 20px auto;">
		<div class="tabPanel">
			<ul>
				...
				<li style="font-size: 14px;" class="hit" onclick="javascript:getAllFinishedBacklog();">所有事项</li>
			</ul>
			<div class="panes">
				<div class="pane" style="display: block;">
					<form action="/backlog/getAll.htm" method="post" id="searchForm">
					...
					<table border="1" align="center" cellpadding="1" cellspacing="1" class="list_table stripe">
						...
						<tr>
							...
							<td style="text-align: center;">
								<a href="/project/viewProcessHistory.htm?projectId=${project.id}">查看</a>
							</td>
						</tr>
						</#list>
					</table>
