...
<div id="content">
        <table border="1" cellspacing="1" cellpadding="1" class="input_table">
              ...
              <tr>
                ...
                <td width="48%" style=" background-color:#fff;">${project.no }</td>
              </tr>
              <tr>
                <td class="tab_title">文件内容</td>
                <td style=" background-color:#fff;">${step8.fileContent }</td>
                <td class="tab_title">编制人</td>
                <td style=" background-color:#fff;">${step8.writeName }</td>
              </tr>
          <tr>
          ...
          <tr>
            ...
            <span style=" float:left; width:60%;background-color:#fff;">审定人1：</span>
            <span style=" float:left;width:40%;background-color:#fff;">日期1：</span>
            </td>
            <td colspan="2">
            <textarea  readOnly="readOnly"  rows="5" style=" width:100%; border:1px solid #c1e9ff; margin-top:5px; margin-bottom:5px;"></textarea>
            <span style=" float:left; width:60%;background-color:#fff;">审定人2：</span>
            <span style=" float:left;width:40%;background-color:#fff;">日期2：</span>
            </td>
              </tr>
              
              <tr>
                <td class="tab_title">审核比例</td>
                <td style=" background-color:#fff;">${step8.auditPercent}</td>
                <td class="tab_title">进度系数</td>
                <td style=" background-color:#fff;">${step8.progress }</td>
              </tr>
