$(function($) {
	...
	// $('.fixed-leftmenu
	// #col-left').nanoScroller({alwaysVisible:true,iOSNativeScrolling:false,preventPageScrolling:true,contentClass:'col-left-nano-content'});
	...
	// add 20150706
	 var url = window.location;
	    var element = $('ul.submenu a').filter(function() {
