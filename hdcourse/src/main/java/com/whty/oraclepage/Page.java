...
public class Page implements java.io.Serializable {
	...
	public void debug1() {
		...
		String debug = "共有数据数:" + totalRows + "共有页数:" + totalPage + "当前页数为:" + currentPage + "是否有前一页:" + hasPreviousPage
	...
	public void setPagedView(String path) {
		...
		if (hasNextPage) {
			...
			sb.append("&nbsp;&nbsp;");
			sb.append("<a href='" + path + "page=" + totalPage
		...
		sb.append("文档总数: " + totalRows + ", 共" + totalPage + "页, 第" + currentPage + "页, 转到 ");
		...
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
		sb.append("<INPUT name=totalPages type=hidden value='" + totalPage + "'>");
		sb.append("&nbsp;&nbsp;");
	...
	public void setPagedView() {
		...
		sb.append("&nbsp;&nbsp;");
		if (hasPreviousPage) {
			// sb.append("<a href='#' onclick='search_pagedForm(1);return
			// false;'><IMG title='第一页'
			// src='<%=basePath%>resource/images/firstbtn.png' border=0></a>");
			...
			// + (currentPage - 1)
			// + ");return false;'><IMG title='上一页' src='../../images/1.gif'
			// border=0></a>");
		} else {
			sb.append(
					"<input type='button' value='首页' class='button' onclick='search_pagedForm(1);return false;' disabled='disabled'>");
			sb.append("&nbsp;&nbsp;");
			sb.append("<input type='button' value='上一页' class='button' onclick='search_pagedForm(" + (currentPage - 1)
		...
		if (hasNextPage) {
			...
			// sb.append("<a href='#' onclick='search_pagedForm("
			// + (currentPage + 1)
			// + ");return false;'><IMG title='下一页' src='../../images/2.gif'
			// border=0></a>");
			sb.append("&nbsp;&nbsp;");
			sb.append("<input type='button' value='末页' class='button' onclick='search_pagedForm(" + totalPage
					+ ");return false;'>");
			// sb.append("<a href='#' onclick='search_pagedForm("
			// + totalPages
			// + ");return false;'><IMG title='最末页' src='../../images/3.gif'
			// border=0></a>");
		} else {
			sb.append("<input type='button' value='下一页' class='button' onclick='search_pagedForm(" + (currentPage + 1)
					+ ");return false;' disabled='disabled'>");
	...
	public void setPagedView1() {
		...
		if (hasPreviousPage) {
			sb.append(
					"<a href='#' onclick='search_pagedForm(1);return false;'><IMG title='第一页' src='../images/0.gif' border=0></a>");
			sb.append("&nbsp;&nbsp;");
		...
		if (hasNextPage) {
			...
			sb.append("&nbsp;&nbsp;");
			sb.append("<a href='#' onclick='search_pagedForm(" + totalPage
	...
	public void setPagedView1(String path) {
		...
		if (hasPreviousPage)
			...
			sb.append(
					"<img src=\"../images/houtui.gif\" border=0>&nbsp;&nbsp;<img src=\"../images/houtui2.gif\" border=0>");
		sb.append("&nbsp;&nbsp;");
		if (hasNextPage)
			sb.append("<a href=\"" + path + "page=" + (currentPage + 1)
					+ "\"><img src=\"../images/qianjin.gif\" border=0></a>&nbsp;&nbsp;<a href=\"" + path + "page="
					+ totalPage + "\"><img src=\"../images/qianjin2.gif\" border=0></a>");
		else
			sb.append(
					"<img src=\"../images/qianjin.gif\" border=0>&nbsp;&nbsp;<img src=\"../images/qianjin2.gif\" border=0>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
		sb.append("当前页/总页数:");
