...
public class DESEDEUtil {
	...
	public static String jiami(String data) throws Exception {
		...
		byte[] aa = data.getBytes("utf-8");
		String tt = new String(aa, "utf-8");

		byte[] identifycode = encrypt(tt.getBytes(), vk);

		return new String(Base64.encodeBase64(identifycode), "UTF-8");
	}

	public static String jiemi(String data) throws Exception {
		byte[] b = new byte[] { 0x58, (byte) 0x88, 0x10, 0x40, 0x38, 0x28, 0x25, 0x79 };
		System.out.println("b: " + new String(Base64.encodeBase64(b), "UTF-8"));
		final byte[] GK = { 0x11, 0x22, 0x4F, 0x58, (byte) 0x88, 0x10, 0x40, 0x38, 0x28, 0x25, 0x79, 0x51, (byte) 0xCB,
				(byte) 0xDD, 0x55, 0x66, 0x11, 0x22, 0x4F, 0x58, (byte) 0x88, 0x10, 0x40, 0x38 }; // 16字节密钥
		...
		byte[] licenceCode2 = decrypt(Base64.decodeBase64(data), vk);
		return new String(licenceCode2);
	}

	public static void main(String[] args) throws Exception {
		String data = "noIs-HFMs-Bp5z";
		String jimi = jiami(data);
		//
		System.out.println(jimi);
		//
		String jiemi = jiemi(jimi);
		...
		byte[] licenceCode2 = decrypt(Base64.decodeBase64("kE0TQFziUgCyEPZiOPAzeg=="), vk);
