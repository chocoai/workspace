...
import com.whty.assis.demo.dao.OverseasLicenceOrgDao;
 ...
 */
@Service
public class OverseasLicenceOrgServiceImpl implements OverseasLicenceOrgService {
	private static Logger logger = LoggerFactory.getLogger(LicenceOrgServiceImpl.class);

	@Autowired
	private OverseasLicenceOrgDao licenceOrgDao;
