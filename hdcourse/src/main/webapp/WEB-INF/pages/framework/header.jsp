...
<div class="wd_main">
	<div class="wd_head pngimg">
    	<div class="fr pdtb15">${sessionScope.manageUser.account}， 你好　|　
    	<a href="javascript:void(0);" id="changePassword" class="wd_cz"><em class="wd_ico wd_ico1">&nbsp;</em>修改密码</a>　
    	<a href="${ctx}/manageUser/logout" class="wd_cz" target="_parent"><em class="wd_ico wd_ico2">&nbsp;</em>注销</a>　
    	<a href="${ctx}/assistant/softInfo/getSoft" target="_blank" class="wd_cz"><em class="wd_ico wd_ico3">&nbsp;</em>下载</a></div>
    	<div><!-- <a href="javascript:void(0);"> --><img src="${ctx}/images/hdlogo.png" width="287" height="45"><!-- </a> --></div>
    </div>
	<div class="wd_nav" >
