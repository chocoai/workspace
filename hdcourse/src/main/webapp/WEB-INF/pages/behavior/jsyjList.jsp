...
<div class="mg15 txq_main">
	<form id="pageForm"  name="pageForm" action="${ctx}/manage/behavior/jsyjList" method="post">
    ...
    <div class="mgtb10">
		<div class="base_title"><strong>教师用机统计列表</strong></div>
			    ...
			    <tr>
					...
					<td>
						<script type="text/javascript">
							var systemInfo = '<c:out value="${obj.SYSTEM_INFO}"/>';
							var systemName = '其他';
							if(systemInfo.indexOf("NT 5.") != -1){
								systemName = 'XP';
							}else if(systemInfo.indexOf("NT 6.0") != -1){
								systemName = 'Vista';
							}else if(systemInfo.indexOf("NT 6.1") != -1){
								systemName = 'Windows 7';
							}else if(systemInfo.indexOf("NT 6.2") != -1){
								systemName = 'Windows 8';
							}else if(systemInfo.indexOf("NT 6.3") != -1){
								systemName = 'Windows 8.1';
							}else if(systemInfo.indexOf("NT 10.") != -1){
								systemName = 'Windows 10';
							}else if(systemInfo.indexOf("Mac") != -1){
								systemName = 'Mac';
							}else if(systemInfo.indexOf("Linux") != -1){
								systemName = 'Linux';
							}else if(systemInfo.indexOf("X11") != -1||systemInfo.indexOf("Unix") != -1){
								systemName = 'Unix';
							}
	...
	<div class="base_page clearfix">
		...
		<c:if test="${fn:length(list) > 0}">
				...
				action="${ctx}/manage/behavior/jsyjList"></newTag:page>
		</c:if>
	</div>
	</form>
</div>
