...
function Run() {
	...
	var userId = '546a4e5ed8914c02aa4e5ed8915c0240';
	var platformCode = '320585';
	

	var url = '"IntelligentClassApp://<?xml version=\'1.0\' encoding=\'utf-8\'?><WebParam><txId>goDy89cfmgmUZdNwwgt9CR67zd9aSDPK</txId><usessionId></usessionId><userPlatformCode></userPlatformCode><platformCode>'+platformCode+'</platformCode><bookId></bookId><uId>'+userId+'</uId><AccessToken></AccessToken><startType>1</startType></WebParam>"'; 
	   var flag=true;
	    try{
	        $.ajax({
	            type: "GET",
