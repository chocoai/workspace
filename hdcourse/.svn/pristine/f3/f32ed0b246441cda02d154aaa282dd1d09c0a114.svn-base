...
function editModular(treeNode){
	...
	var hdktVersion = currModular.hdktVersion;
	
	
	
	$("input[name='hdktVersion']").each(function(){
		$(this).attr("checked", false);
    });	
	
	$("input[name='hdktVersion']").each(function(){
		
		var vesionStr = hdktVersion.split(",");
		
		for(var i=0;i<vesionStr.length;i++){
			if($(this).val() == vesionStr[i]){
	...
	$('#behaviorcode').val(currModular.behaviorcode);
	...
	$("#typeName").val(currModular.typeName);
...
$(document).ready(function(){
	...
	$("#save").click(function(){
		...
		var behaviorcode = $("#behaviorcode").val();
	...
	<div class="fl" style="width: 25%;border: 2px solid #dadada;">
   	...
   	<div class="fr" style="width: 73%">
       	<div class="base_title"><strong>应用信息</strong></div>
             ...
             <tr>
               <td align="right">软件类型名：</td>
               <td>
               		<input type="text" id="typeName" class="inp focus" style="width:340px;"/>
               	</td>
             </tr>
             
             <tr>
               <td align="right">互动课堂版本：</td>
               <td>
               		<input name="hdktVersion" type="checkbox"  value="2.6.0" />2.6.0
               		<input name="hdktVersion" type="checkbox" value="2.6.1" />2.6.1
               	</td>
             </tr>
             
             <tr>
               <td align="right">压缩包版本：</td>
               <td>
              ...
              <tr>
               ...
               <td>
               	<select id="subjectId" class="sel" style="width:100px;">
               		...
               		<option value="jcsub12">地理</option>
               		<option value="jcsub20">音乐</option>
               		<option value="jcsub14">化学</option>
            ...
            <tr>
               ...
               <td>
               	<input type="text" id="behaviorcode" class="inp focus" style="width:340px;"/>
               </td>
            </tr>
