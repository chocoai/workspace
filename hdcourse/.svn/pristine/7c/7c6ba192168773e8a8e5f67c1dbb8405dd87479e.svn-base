 ...
 */
@Controller
@RequestMapping("/manage/terminalUseCount")
public class TerminalUseCountController extends BaseController {

	@Autowired
	private TerminalUseHistoryService terminalUseHistoryService;
	...
	public void exportExcel(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		...
		if (paramMap.get("provinceCode") == null) {
			...
			terminalUseHistoryList = terminalUseHistoryService.getTerminalUseHistoryCount(param);
			...
			terminalUseHistoryList = terminalUseHistoryService.getTerminalUseHistoryCountByOrg(param);
			...
			// page.setPagination(false);
			terminalUseHistoryList = terminalUseHistoryService.getTerminalUseHistoryCountByAreaCode(param);
			...
			// page.setPagination(false);
			terminalUseHistoryList = terminalUseHistoryService.getTerminalUseHistoryCountByProvinceCode(param);
		}
	...
	public String list(HttpServletRequest request, Model model) throws Exception {
		...
		// 查询学校
		if (paramMap.get("cityCode") != null && StringUtils.isNotEmpty(paramMap.get("cityCode").toString())) {
			List<Map> list = terminalUseHistoryService.getOrgListByAreaCode(paramMap.get("cityCode").toString());
		...
		if (paramMap.get("provinceCode") == null) {
			...
			param.put("month", month);
			// page.setPagination(false);
			handlerResult = terminalUseHistoryService.getTerminalUseHistoryCountPage(param);
			page.setPagination(false);
			terminalUseHistoryList = terminalUseHistoryService.getTerminalUseHistoryCount(param);
			page.setPagination(true);
		} else if (paramMap.get("orgId") != null && StringUtils.isNotEmpty(paramMap.get("orgId").toString())) {// 机构查询
			...
			param.put("orgId", paramMap.get("orgId"));
			page.setPagination(false);
			handlerResult = terminalUseHistoryService.getTerminalUseHistoryCountByOrgPage(param);// 学校下所有用户的统计
			page.setPagination(true);
			// page.setPagination(false);
			terminalUseHistoryList = terminalUseHistoryService.getTerminalUseHistoryCountByOrg(param);
			// page.setPagination(true);
			...
			// page.setPagination(true);
			page.setPagination(false);
			handlerResult = terminalUseHistoryService.getTerminalUseHistoryCountByAreaCodePage(param);// 区域下所有学校的统计
			page.setPagination(true);
		} else if (paramMap.get("provinceCode") != null
				&& StringUtils.isNotEmpty(paramMap.get("provinceCode").toString())) {
			// 当月数据
			...
			// page.setPagination(true);
			page.setPagination(false);
			handlerResult = terminalUseHistoryService.getTerminalUseHistoryCountByProvinceCodePage(param);// 找到所有区域的统计
			page.setPagination(true);
		}
