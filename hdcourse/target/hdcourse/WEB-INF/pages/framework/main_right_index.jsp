...
<div class="mg15">
	<div class="wd_welcome clearfix">
        ...
        <div class="fl">
        	<p class="f16">欢迎你　${sessionScope.manageUser.account}　，现在是<span id="now"></span></p>
            <p><span class="c8">上次登录时间：</span><fmt:formatDate value="${sessionScope.manageUser.last_time}" pattern="yyyy年MM月dd日 HH:mm:ss"/></p>
        </div>
    </div>
    ...
    <div class="pdtb15 wd_pdb10 clearfix">
        ...
        <div class="fl">
            ...
            <p><span class="c8">用户名：</span>${sessionScope.manageUser.account} </p>
