...
<body>
<div class="bo_main">
	<h2 class="adminTit bor_bottom"><em>功能使用统计</em><span class="fr"></span></h2>
    <div class="data_index mgt15">
       
    </div>
    
    <form id="pageForm"  name="pageForm" action="${ctx}/manage/widgetCount/list" method="post">
...
function exportExcel(){
	...
	window.location.href='${ctx}/manage/widgetCount/exportExcel?province=' + province+'&city='+city+'&org='+org+'&startTime='+startTime+'&endTime='+endTime+'&start_time='+start_time;
}
...
function queryOrg(areaCode){
	...
	$.ajax({
		type : "POST",
		url : "${ctx}/manage/widgetCount/queryOrg",
	...
	var optionA = { 
        ...
        yAxis: {
			...
			data : (function(){
		        ...
		        type : "post",
		        async : false, //同步执行
		        url : "${ctx}/manage/widgetCount/chartsData",
