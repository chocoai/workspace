...
<body>
<div class="bo_main">
	<form id="pageForm"  name="pageForm" action="${ctx}/manage/countUseTaking/userCount" method="post">
   ...
   <div class="code_table data_index">
        <table class="mod_table t_c" width="100%" style="border-collapse:collapse;">
            <tr>
                ...
                <td width="10%">
                	<p>总时长</p>
                    <p class="num"><span class="c00f">${loginTakingTotal}</span></p>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table class="small_space data_list" width="100%" style="border-collapse:collapse;">
            ...
            <c:forEach items="${userCountList}" var="userCount" varStatus="status">
             	<tr>
             		...
             		<td>${time}</td>
             		<td>${userCount.useTakingStr}</td>
             		<td>${userCount.previousUseTakingStr}</td>
    ...
    <div class="base_page clearfix">
		...
		<c:if test="${fn:length(userCountList) > 0}">
				...
				action="${ctx}/manage/countUseTaking/userCount"></newTag:page>
		</c:if>
	</div>
	</form>
</div>
...
function exportUserCountExcel(){
	...
	window.location.href='${ctx}/manage/countUseTaking/exportUserTakingCountExcel?province=' + province+'&cityCode='+city+'&org='+org+'&start_time='+start_time+"&orgName="+orgName;
}
	...
	var optionA = { 
        ...
        yAxis: {
            ...
            data: (function(){
		        ...
		        type : "post",
		        async : false, //同步执行
		        url : "${ctx}/manage/countUseTaking/getUserUseTakingChartsData",
