...
<div class="mg15 txq_main">
	...
	<form id="pageForm"  name="pageForm" action="${ctx}/manage/useCount/areaList" method="post">
		<div class="clearfix">
        ...
        <div class="mgtb10">
			<div class="base_title"><strong>区域使用次数统计</strong></div>
		...
		<c:if test="${fn:length(useCountList) > 0}">
				...
				action="${ctx}/manage/useCount/areaList"></newTag:page>
		</c:if>
		</div>
...
function exportAreaUseCountExcel(){
	...
	window.location.href='${ctx}/manage/useCount/exportAreaUseCountExcel?provinceCode='+province+'&cityCode='+city+'&areaCode='+area+'&orgName='+ orgName;
}
