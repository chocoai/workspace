...
Ext.onReady(function() {
	...
	Ext.define('App.TestDemoWindow', {
		...
		constructor : function(config) {
									...
									success : function(response) {
										if (response.responseText != '') {
											...
											if (res.success) {
												...
												Ext.getCmp('TestDemogrid').getStore().reload();
											} else {
			...
			App.TestDemoWindow.superclass.constructor.call(this, config);
		}
	});
	
	//查询表单
	Ext.define('Yhcrt.app.systemManage.TestDemoSearchForm', {
	...
	}); //Yhcrt.app.systemManage.TestDemoManagement

	var store ;
	Ext.define('Yhcrt.app.systemManage.TestDemoGrid', {
			...
			var columns = [ {
				...
				items : [ {
					...
					handler : function(grid, rowIndex, colIndex) {
						...
						var win = new App.TestDemoWindow({
							hidden : true
						});
				...
				//		form.findField('type').hide();
						...
						Ext.getCmp('TestDemowindow-save').hide();
						Ext.getCmp('TestDemowindow-cancel').hide();
						Ext.getCmp('TestDemowindow-accept').show();
						win.show();
					}
				}, {
					iconCls : 'edit',
					...
					handler : function(grid, rowIndex, colIndex) {
						...
						win.setHeight(250);
						var form = win.down('form').getForm();
						form.findField('createtime').hide();
						form.loadRecord(gridRecord);
		...
		onAddClick : function() {
			new App.TestDemoWindow().show();
		},
		onViewClick : function() {
			var grid = Ext.getCmp("TestDemogrid");
	...
	Ext.define('Yhcrt.app.systemManage.TestDemoManagement', {
		...
		initComponent : function() {
			var me = this;
			me.items = [Ext.create('Yhcrt.app.systemManage.TestDemoSearchForm',me.config),Ext.create('Yhcrt.app.systemManage.TestDemoGrid',me.config)];
