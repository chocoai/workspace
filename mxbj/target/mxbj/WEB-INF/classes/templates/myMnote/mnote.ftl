    ...
    <div class="gs_teachingShareWrap">
        ...
        <div class="gs_shareList clearfix mgb20">
            ...
            <div class="gs_selecDrop fl">
                ...
                <ul class="gs_selectDropList">
                    <li><a href="javascript:;">我的专题课</a></li>
                    <li><a href="javascript:;">我的课题研究</a></li>
...
$(function () {
	...
	$(function(){
        ...
        $('.bds_teach').on('click', function () {
            ...
            //var a = $('.gs_teachingShare_dialog');
            // var dialog = diaLog(a, '分享 ', '720px', function () {
            //     var That = this;
            //     var btnTue = a.find("a[true]");
            //     var btnFalse = a.find('a[false]');
            //     btnTue && btnTue.off('click');
        ...
        $('.gs_selectDropList').on('click','li',function () {
            var $this = $(this);
