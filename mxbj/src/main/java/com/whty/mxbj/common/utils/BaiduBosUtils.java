...
public class BaiduBosUtils {
	...
	public static String getKey(String userId, String fileName) {
		...
		bosStringBuffer.append("zhkt").append(SysConfigUtils.getStrValue("projectName")).append("/").append(year).append("/")
				.append(month).append("/").append(date).append("/").append(userId).append("/").append(fileName);
