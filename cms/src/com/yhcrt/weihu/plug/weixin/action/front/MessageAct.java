package com.yhcrt.weihu.plug.weixin.action.front;
...
import com.yhcrt.weihu.plug.weixin.manager.WeixinMessageMng;
import com.yhcrt.weihu.plug.weixin.manager.WeixinMng;

@Controller("frontMessageAct")
public class MessageAct {
    ...
    private String contentWithImgUseContent(Content entity,String fromUsername,String toUsername,String time,HttpServletRequest request){
    	CmsSite site = CmsUtils.getSite(request);
    	String path = site.getDomain();
    	String textTpls =text(fromUsername, toUsername, time, entity.getTitle(), entity.getDescription(), "http://"+path+entity.getTypeImg(), entity.getUrl());
    	return textTpls;
    }
