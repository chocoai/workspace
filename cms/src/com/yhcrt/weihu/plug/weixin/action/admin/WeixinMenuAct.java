package com.yhcrt.weihu.plug.weixin.action.admin;
...
import com.yhcrt.weihu.cms.service.WeiXinSvc;
...
import com.yhcrt.weihu.plug.weixin.manager.WeixinMenuMng;
...
public class WeixinMenuAct {
	...
	public String menu(WeixinMenu bean,Integer parentId,Integer pageNo,HttpServletRequest request, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		List<WeixinMenu> menus = manager.getList(site.getId());
