package com.yhcrt.weihu.plug.weixin.entity.base;
...
public abstract class BaseWeixinMenu  implements Serializable {
	...
	// many to one
	private com.yhcrt.weihu.plug.weixin.entity.WeixinMenu parent;
	private com.yhcrt.weihu.core.entity.CmsSite site;

	// collections
	private java.util.Set<com.yhcrt.weihu.plug.weixin.entity.WeixinMenu> child;
	 ...
	 */
	public com.yhcrt.weihu.plug.weixin.entity.WeixinMenu getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.yhcrt.weihu.plug.weixin.entity.WeixinMenu parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.plug.weixin.entity.WeixinMenu> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.yhcrt.weihu.plug.weixin.entity.WeixinMenu> child) {
		this.child = child;
	}

	public void addTochild (com.yhcrt.weihu.plug.weixin.entity.WeixinMenu weixinMenu) {
		if (null == getChild()) setChild(new java.util.TreeSet<com.yhcrt.weihu.plug.weixin.entity.WeixinMenu>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.plug.weixin.entity.WeixinMenu)) return false;
		else {
			com.yhcrt.weihu.plug.weixin.entity.WeixinMenu weixinMenu = (com.yhcrt.weihu.plug.weixin.entity.WeixinMenu) obj;
