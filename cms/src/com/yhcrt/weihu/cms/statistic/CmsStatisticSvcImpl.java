...
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.JOIN;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.MEMBER;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.THISMONTH;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.THISWEEK;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.THISYEAR;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.TIMEPATTERN;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.TODAY;
import static com.yhcrt.weihu.cms.statistic.CmsStatistic.YESTERDAY;
...
import com.yhcrt.weihu.cms.statistic.CmsStatistic.TimeRange;
import com.yhcrt.weihu.common.util.DateFormatUtils;

@Service
@Transactional(readOnly = true)
public class CmsStatisticSvcImpl implements CmsStatisticSvc {
    public List<CmsStatistic> statisticByModel(int type, CmsStatisticModel statisticModel, Integer year, Integer month,
    ...
    private List<CmsStatistic> statisticByModel(int type, CmsStatisticModel statisticModel, Calendar calendar,
