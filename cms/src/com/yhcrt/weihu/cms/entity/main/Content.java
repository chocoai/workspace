...
import static com.yhcrt.weihu.common.web.Constants.SPT;
...
import com.yhcrt.weihu.cms.entity.main.base.BaseContent;
import com.yhcrt.weihu.cms.staticpage.StaticPageUtils;
...
import com.yhcrt.weihu.core.entity.CmsWorkflowNode;
import com.yhcrt.weihu.core.web.ContentInterface;
...
public class Content extends BaseContent implements ContentInterface {
	...
	public Integer getCommts() {
		return getContentCount().getComments();
...
//			return getUrlDynamic(null);
	...
	public void addToContentTopic(Integer topicId,Integer topicChannelId){
	    List<ContentTopic> contentTopics = getContentTopic();
	    if (contentTopics == null) {
		contentTopics = new ArrayList<ContentTopic>();
		setContentTopic(contentTopics);
	    }
	    ContentTopic contentTopic = new ContentTopic(topicId, topicChannelId);
	    contentTopics.add(contentTopic);
	}
	
	public void addToTopicChannels(TopicChannel topicChannel) {
		Set<TopicChannel> topicChannels = getTopicChannels();
		if (topicChannels == null) {
		    topicChannels = new HashSet<TopicChannel>();
			setTopicChannels(topicChannels);
		}
		topicChannels.add(topicChannel);
	}
	 ...
	 */
	public Content(java.lang.Integer id,
			com.yhcrt.weihu.core.entity.CmsSite site, java.util.Date sortDate,
			...
			java.lang.Integer changeState) {

		super(id, site, sortDate, topLevel, hasTitleImg, recommend, status,
				viewsDay, commentsDay, downloadsDay, upsDay,changeState);
	}
