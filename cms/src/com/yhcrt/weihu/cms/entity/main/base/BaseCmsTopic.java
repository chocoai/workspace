...
/**
 * This is an object that contains data related to the jc_topic table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="jc_topic"
 */
...
public abstract class BaseCmsTopic implements Serializable {
     ...
     */
    public BaseCmsTopic(java.lang.Integer id, java.lang.String name, java.lang.Integer priority,
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.CmsTopic))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.CmsTopic cmsTopic = (com.yhcrt.weihu.cms.entity.main.CmsTopic) obj;
	    if (null == this.getId() || null == cmsTopic.getId())
		return false;
	    else
		return (this.getId().equals(cmsTopic.getId()));
	}
    }
