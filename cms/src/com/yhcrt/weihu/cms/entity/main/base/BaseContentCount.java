 ...
 *
 * @hibernate.class table="jc_content_count"
 */
...
public abstract class BaseContentCount implements Serializable {
     ...
     */
    public BaseContentCount(java.lang.Integer id, java.lang.Integer views, java.lang.Integer viewsMonth,
	    java.lang.Integer viewsWeek, java.lang.Integer viewsDay, java.lang.Integer comments,
	    java.lang.Integer commentsMonth, java.lang.Short commentsWeek, java.lang.Short commentsDay,
	    java.lang.Integer downloads, java.lang.Integer downloadsMonth, java.lang.Short downloadsWeek,
	    java.lang.Short downloadsDay, java.lang.Integer ups, java.lang.Integer upsMonth, java.lang.Short upsWeek,
	    java.lang.Short upsDay, java.lang.Integer downs) {
     ...
     * 
     * @param downloadsMonth
     *            the downloads_month value
     */
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ContentCount))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ContentCount contentCount = (com.yhcrt.weihu.cms.entity.main.ContentCount) obj;
	    if (null == this.getId() || null == contentCount.getId())
		return false;
	    else
		return (this.getId().equals(contentCount.getId()));
	}
    }
