 ...
 *
 * @hibernate.class table="jc_content_check"
 */
...
public abstract class BaseContentCheck implements Serializable {
     ...
     */
    public BaseContentCheck(java.lang.Integer id, java.lang.Byte checkStep, java.lang.Boolean rejected) {
    ...
    private com.yhcrt.weihu.core.entity.CmsUser reviewer;
    ...
    public com.yhcrt.weihu.core.entity.CmsUser getReviewer() {
	return reviewer;
    }

    public void setReviewer(com.yhcrt.weihu.core.entity.CmsUser reviewer) {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ContentCheck))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ContentCheck contentCheck = (com.yhcrt.weihu.cms.entity.main.ContentCheck) obj;
	    if (null == this.getId() || null == contentCheck.getId())
		return false;
	    else
		return (this.getId().equals(contentCheck.getId()));
	}
    }
