...
/**
 * This is an object that contains data related to the jc_content_ext table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_content_ext"
 */
...
public abstract class BaseContentExt implements Serializable {
     ...
     */
    public BaseContentExt(java.lang.Integer id, java.lang.String title, java.util.Date releaseDate,
	    java.lang.Boolean bold, java.lang.Boolean needRegenerate) {
     ...
     * 
     * @param needRegenerate
     *            the need_regenerate value
     */
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ContentExt))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ContentExt contentExt = (com.yhcrt.weihu.cms.entity.main.ContentExt) obj;
	    if (null == this.getId() || null == contentExt.getId())
		return false;
	    else
		return (this.getId().equals(contentExt.getId()));
	}
    }
