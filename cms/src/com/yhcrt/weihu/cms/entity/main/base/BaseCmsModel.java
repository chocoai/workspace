...
/**
 * This is an object that contains data related to the jc_model table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="jc_model"
 */
...
public abstract class BaseCmsModel implements Serializable {
     ...
     */
    public BaseCmsModel(java.lang.Integer id, java.lang.String name, java.lang.String path,
	    java.lang.Integer titleImgWidth, java.lang.Integer titleImgHeight, java.lang.Integer contentImgWidth,
	    java.lang.Integer contentImgHeight, java.lang.Integer priority, java.lang.Boolean hasContent,
    ...
    // collections
    private java.util.Set<com.yhcrt.weihu.cms.entity.main.CmsModelItem> items;

    /**
     * Return the unique identifier of this class
     * 
     * @hibernate.id generator-class="assigned" column="model_id"
     */
     ...
     * 
     * @param tplChannelPrefix
     *            the tpl_channel_prefix value
     */
     ...
     * 
     * @param tplContentPrefix
     *            the tpl_content_prefix value
     */
     ...
     */
    public java.util.Set<com.yhcrt.weihu.cms.entity.main.CmsModelItem> getItems() {
	return items;
    }
     ...
     *            the items value
     */
    public void setItems(java.util.Set<com.yhcrt.weihu.cms.entity.main.CmsModelItem> items) {
	this.items = items;
    }
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.CmsModel))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.CmsModel cmsModel = (com.yhcrt.weihu.cms.entity.main.CmsModel) obj;
	    if (null == this.getId() || null == cmsModel.getId())
		return false;
	    else
		return (this.getId().equals(cmsModel.getId()));
	}
    }
