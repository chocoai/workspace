...
/**
 * This is an object that contains data related to the jc_content_share_check
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="jc_content_share_check"
 */
...
public abstract class BaseContentShareCheck implements Serializable {
     ...
     */
    public BaseContentShareCheck(java.lang.Integer id, com.yhcrt.weihu.cms.entity.main.Content content,
	    com.yhcrt.weihu.cms.entity.main.Channel channel, java.lang.Byte checkStatus, java.lang.Boolean shareValid) {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ContentShareCheck))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ContentShareCheck contentShareCheck = (com.yhcrt.weihu.cms.entity.main.ContentShareCheck) obj;
	    if (null == this.getId() || null == contentShareCheck.getId())
		return false;
	    else
		return (this.getChannel().equals(contentShareCheck.getChannel())
			&& this.getContent().equals(contentShareCheck.getContent()));
	}
    }
