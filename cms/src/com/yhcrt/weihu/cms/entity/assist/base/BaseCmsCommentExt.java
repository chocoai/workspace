...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	// one to one
	private com.yhcrt.weihu.cms.entity.assist.CmsComment comment;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (com.yhcrt.weihu.cms.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsCommentExt)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsCommentExt cmsCommentExt = (com.yhcrt.weihu.cms.entity.assist.CmsCommentExt) obj;
