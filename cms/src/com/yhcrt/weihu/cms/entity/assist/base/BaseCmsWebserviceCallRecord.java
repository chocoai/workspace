...
public abstract class BaseCmsWebserviceCallRecord  implements Serializable {
	...
	public BaseCmsWebserviceCallRecord (
		...
		com.yhcrt.weihu.cms.entity.assist.CmsWebserviceAuth auth,
	...
	// many to one
	private com.yhcrt.weihu.cms.entity.assist.CmsWebserviceAuth auth;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsWebserviceAuth getAuth () {
		return auth;
	}
	 ...
	 */
	public void setAuth (com.yhcrt.weihu.cms.entity.assist.CmsWebserviceAuth auth) {
		this.auth = auth;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsWebserviceCallRecord)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsWebserviceCallRecord cmsWebserviceCallRecord = (com.yhcrt.weihu.cms.entity.assist.CmsWebserviceCallRecord) obj;
