...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		...
		com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic voteTopic,
	...
	// many to one
	private com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsVoteSubTopic)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.yhcrt.weihu.cms.entity.assist.CmsVoteSubTopic) obj;
