...
public abstract class BaseCmsMessage  implements Serializable {
	...
	// many to one
	private com.yhcrt.weihu.core.entity.CmsUser msgReceiverUser;
	private com.yhcrt.weihu.core.entity.CmsUser msgSendUser;
	private com.yhcrt.weihu.core.entity.CmsSite site;
	
	// collections
	private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> receiverMsgs;
	 ...
	 */
	public com.yhcrt.weihu.core.entity.CmsUser getMsgReceiverUser () {
	 ...
	 */
	public void setMsgReceiverUser (com.yhcrt.weihu.core.entity.CmsUser msgReceiverUser) {
	 ...
	 */
	public com.yhcrt.weihu.core.entity.CmsUser getMsgSendUser () {
		return msgSendUser;
	}
	 ...
	 */
	public void setMsgSendUser (com.yhcrt.weihu.core.entity.CmsUser msgSendUser) {
	...
	public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> getReceiverMsgs() {
		return receiverMsgs;
	}

	public void setReceiverMsgs(
			java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> receiverMsgs) {
		this.receiverMsgs = receiverMsgs;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsMessage)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsMessage cmsMessage = (com.yhcrt.weihu.cms.entity.assist.CmsMessage) obj;
