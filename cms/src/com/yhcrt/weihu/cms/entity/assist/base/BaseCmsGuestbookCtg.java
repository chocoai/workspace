...
public abstract class BaseCmsGuestbookCtg  implements Serializable {
	...
	public void setDepartments(
			java.util.Set<com.yhcrt.weihu.core.entity.CmsDepartment> departments) {
		this.departments = departments;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsGuestbookCtg)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsGuestbookCtg cmsGuestbookCtg = (com.yhcrt.weihu.cms.entity.assist.CmsGuestbookCtg) obj;
