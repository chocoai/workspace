package com.yhcrt.weihu.cms.lucene;
...
public class LuceneContent {
	...
	public static final String[] QUERY_FIELD = { TITLE, CONTENT,CONTENT1,CONTENT2,CONTENT3 };
	public static final BooleanClause.Occur[] QUERY_FLAGS = {BooleanClause.Occur.SHOULD, BooleanClause.Occur.SHOULD, BooleanClause.Occur.SHOULD, BooleanClause.Occur.SHOULD, BooleanClause.Occur.SHOULD };
