...
import com.yhcrt.weihu.cms.dao.assist.CmsSearchWordsDao;
...
import com.yhcrt.weihu.common.util.ChineseCharToEn;

@Repository
public class CmsSearchWordsDaoImpl extends HibernateBaseDao<CmsSearchWords, Integer> implements CmsSearchWordsDao {
	public Pagination getPage(int pageNo, int pageSize) {
		Finder f=Finder.create("from CmsSearchWords words order by words.priority asc");
