 ...
 * TOM
 */
package com.yhcrt.weihu.cms.webservices;

import org.apache.commons.lang.StringUtils;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.context.support.SpringBeanAutowiringSupport;

import com.yhcrt.weihu.cms.manager.assist.CmsWebserviceAuthMng;
import com.yhcrt.weihu.cms.manager.assist.CmsWebserviceCallRecordMng;
...
public class UserService extends SpringBeanAutowiringSupport {
    ...
    public String addUser(String auth_username, String auth_password, String admin, String username,
	    ...
	    String rank, String departmentId, String role, String site, String allChannel,
	    String allControlChannel) {
	...
	if (validate(auth_username, auth_password)) {
		...
		try {
			...
			cmsUserMng.registerMember(username, email, password, LOCAL_IP,
				group.getId(), null, false, userExt, null);
			...
			if (StringUtils.isNotBlank(site)) {
				...
				allControlChannels[i] = Boolean
					.parseBoolean(allControlChannelArray[i]);
			    }
			}
			cmsUserMng.saveAdmin(username, email, password, LOCAL_IP, false, false,
				rankInt, group.getId(), Integer.parseInt(departmentId), roleIds,
				null, siteIds, steps, allChannels, allControlChannels, userExt);
		    }
    ...
    public String updateUser(String auth_username, String auth_password, String username,
	    String password, String email, String realname, String sex, String tel,
	    String groupId) {
	String responseCode = RESPONSE_CODE_AUTH_ERROR;
	if (validate(auth_username, auth_password)) {
		...
		if (user != null) {
			...
			cmsUserMng.updateMember(user.getId(), email, password, groupInt, realname,
				tel, gender);
			responseCode = RESPONSE_CODE_SUCCESS;
