...
import com.yhcrt.weihu.cms.entity.assist.CmsAdvertisingSpace;
import com.yhcrt.weihu.cms.manager.assist.CmsAdvertisingMng;
import com.yhcrt.weihu.cms.manager.assist.CmsAdvertisingSpaceMng;
...
public class CmsAdvertisingAct {
    ...
    public String list(Integer queryAdspaceId, Boolean queryEnabled, Integer pageNo, HttpServletRequest request,
	    ModelMap model) {
	CmsSite site = CmsUtils.getSite(request);
	Pagination pagination = manager.getPage(site.getId(), queryAdspaceId, queryEnabled, cpn(pageNo),
		CookieUtils.getPageSize(request));
	List<CmsAdvertisingSpace> adspaceList = cmsAdvertisingSpaceMng.getList(site.getId());
	...
	model.addAttribute("adspaceList", cmsAdvertisingSpaceMng.getList(site.getId()));
    ...
    public String update(Integer queryAdspaceId, Boolean queryEnabled, CmsAdvertising bean, Integer adspaceId,
    ...
    public String delete(Integer[] ids, Integer queryAdspaceId, Boolean queryEnabled, Integer pageNo,
    ...
    public String uploadFlash(@RequestParam(value = "flashFile", required = false) MultipartFile file, String flashNum,
	    HttpServletRequest request, ModelMap model) {
