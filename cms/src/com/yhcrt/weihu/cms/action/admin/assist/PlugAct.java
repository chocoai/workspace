...
import com.yhcrt.weihu.cms.manager.assist.CmsPlugMng;
...
public class PlugAct {
    ...
    public String update(CmsPlug bean, Integer pageNo, HttpServletRequest request, ModelMap model) throws IOException {
    ...
    public String uploadSubmit(@RequestParam(value = "plugFile", required = false) MultipartFile file,
    ...
    public void install(Integer id, HttpServletRequest request, HttpServletResponse response, ModelMap model)
    ...
    public void uninstall(Integer id, HttpServletRequest request, HttpServletResponse response, ModelMap model)
	    throws IOException, JSONException {
	CmsUser user = CmsUtils.getUser(request);
	JSONObject object = new JSONObject();
	if (user == null) {
