 ...
 * 评论分页标签
 */
public class CmsBLCommentPageDirective extends AbstractCmsCommentDirective {
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "blcomment_page";
	/**
	 * 输入参数，站点ID。
	 */
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		if (parentId != null ) {
			page = cmsCommentMng.getChildPage(parentId, true, FrontUtils.getPageNo(env), FrontUtils.getCount(params));	
		} else {
			page = cmsCommentMng.getBaoliaoPage(getSiteId(params),
