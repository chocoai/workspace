...
public abstract class AbstractCmsCommentDirective implements
	 ...
	 * 输入参数，报料ID。
	 */
	public static final String PARAM_BAOLIAO_ID = "baoliaoId";
	/**
	 * 输入参数，内容ID。
	 */
	...
	/**
	 * 输入参数，排列顺序。0：按评论时间降序；1：按评论多、时间降序。默认0。
	 */
	public static final String PARAM_ORDER_BY = "orderBy";
	protected Integer getBaoliaoId(Map<String, TemplateModel> params)
			throws TemplateException {
		return DirectiveUtils.getInt(PARAM_BAOLIAO_ID, params);
	}
	...
	protected boolean getOrderBy(Map<String, TemplateModel> params)
			throws TemplateException {
