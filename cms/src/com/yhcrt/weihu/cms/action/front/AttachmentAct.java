...
import com.yhcrt.weihu.cms.entity.main.ContentAttachment;
...
public class AttachmentAct {
	...
	public String down(Integer cid, HttpServletRequest request,
	...
	private void downLoadFile(HttpServletRequest request,
			HttpServletResponse response, ContentDoc doc) throws IOException {
		CmsSite site=CmsUtils.getSite(request);
		// 解决中文乱码
