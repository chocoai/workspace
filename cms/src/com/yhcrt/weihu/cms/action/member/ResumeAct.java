...
import com.yhcrt.weihu.cms.manager.assist.CmsJobApplyMng;
...
import com.yhcrt.weihu.core.manager.CmsUserResumeMng;
...
public class ResumeAct {
	...
	public String myapplys(Integer pageNo,HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		Pagination pagination=jobApplyMng.getPage(user.getId(),null,null,true,cpn(pageNo), 1);
