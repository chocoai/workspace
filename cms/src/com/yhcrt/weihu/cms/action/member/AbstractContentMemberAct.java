...
public class AbstractContentMemberAct {
	...
	public String save(String title, String author, String description,
		...
		c = contentMng.save(c, ext, t,null, null, null, null, null, tagArr, attachmentPaths,attachmentNames, attachmentFilenames
	...
	public String update(Integer id, String title, String author,
			...
			String[] attachmentPaths, String[] attachmentNames,
			String[] attachmentFilenames, String[] picPaths, String[] picDescs,
			ContentDoc doc,String nextUrl, HttpServletRequest request,
			HttpServletResponse response, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		CmsUser user = CmsUtils.getUser(request);
		FrontUtils.frontData(request, model, site);
		...
		t.setTxt(txt);
		String[] tagArr = StrUtils.splitAndTrim(tagStr, ",", null);
		contentMng.update(c, ext, t,null, tagArr, null, null,null, null,  attachmentPaths,attachmentNames, attachmentFilenames
