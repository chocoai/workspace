...
@Controller("memberImageUploadAct")
public class ImageUploadAct {
    ...
    public String execute(String filename, Integer uploadNum, Boolean mark,
	...
	if (errors.hasErrors()) {
	    ...
	    return FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_MEMBER, RESULT_PAGE);
	}
    ...
    private WebCoreErrors validate(String filename, MultipartFile file, HttpServletRequest request) {
