...
public class DocAct extends AbstractContentMemberAct {
    ...
    public String list(String q, Integer modelId, Integer queryChannelId, Integer pageNo, HttpServletRequest request,
	    ModelMap model) {
    ...
    public String save(String title, String author, String description, String txt, String tagStr, Integer channelId,
	    Integer modelId, ContentDoc doc, String captcha, String nextUrl, HttpServletRequest request,
	    HttpServletResponse response, ModelMap model) {
	updateUserUploadDocNum(request, 1);
	return super.save(title, author, description, txt, tagStr, channelId, modelId, doc, captcha, null, null, null,
		null, null, null, null, nextUrl, request, response, model);
    }
    ...
    public String update(Integer id, String title, String author, String description, String txt, String tagStr,
	    Integer channelId, ContentDoc doc, String nextUrl, HttpServletRequest request, HttpServletResponse response,
	    ModelMap model) {
	return super.update(id, title, author, description, txt, tagStr, channelId, null, null, null, null, null, null,
		null, doc, nextUrl, request, response, model);
    }
    ...
    public String uploadDoc(@RequestParam(value = "doc", required = false) MultipartFile file, String docNum,
	...
	errors = validateUploadFileSize(file, CmsUtils.getUser(request).getGroup().getAllowFileSize(), request);
	if (errors.hasErrors()) {
	    model.addAttribute("error", errors.getErrors().get(0));
    ...
    private WebErrors validateUploadFileSize(MultipartFile file, Integer maxSize, HttpServletRequest request) {
	WebErrors errors = WebErrors.create(request);
