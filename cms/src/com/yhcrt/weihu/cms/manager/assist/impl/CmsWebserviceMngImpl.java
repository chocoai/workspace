...
import com.yhcrt.weihu.cms.entity.assist.CmsWebserviceParam;
...
public class CmsWebserviceMngImpl implements CmsWebserviceMng {
	...
	try {
	    ...
	    call.setOperationName(
		    new QName(webservice.getTargetNamespace(), webservice.getOperate()));
    ...
    public void callWebService(String admin, String username, String password, String email,
	    CmsUserExt userExt, String operate) {
