...
public interface CmsFileMng {
	...
	public void updateFileByPathsBL(String[]picPaths,
			String titleImg,Boolean valid,CmsBaoLiao b);
	public void updateFileByPathsTT(String[]picPaths,
			String titleImg,Boolean valid,CmsTT b);
}