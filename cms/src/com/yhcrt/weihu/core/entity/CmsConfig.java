...
import com.yhcrt.weihu.core.entity.base.BaseCmsConfig;
...
public class CmsConfig extends BaseCmsConfig {
    ...
    {
	BbsConfigAttr configAttr = getBbsConfigAttr();
    ...
    public BbsConfigAttr getBbsConfigAttr()
    {
	BbsConfigAttr configAttr = new BbsConfigAttr(getAttr());
	return configAttr;
    }

    public void setBbsConfigAttr(BbsConfigAttr configAttr)
    {
	getAttr().putAll(configAttr.getAttr());
    }
