...
public abstract class BaseCmsWorkflow  implements Serializable {
	...
	// collections
	private java.util.List<com.yhcrt.weihu.core.entity.CmsWorkflowNode> nodes;
	private java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEvent> events;
	 ...
	 */
	public java.util.List<com.yhcrt.weihu.core.entity.CmsWorkflowNode> getNodes () {
		return nodes;
	}
	 ...
	 */
	public void setNodes (java.util.List<com.yhcrt.weihu.core.entity.CmsWorkflowNode> nodes) {
		this.nodes = nodes;
	}
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEvent> getEvents () {
		return events;
	}
	 ...
	 */
	public void setEvents (java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEvent> events) {
		this.events = events;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsWorkflow)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsWorkflow cmsWorkflow = (com.yhcrt.weihu.core.entity.CmsWorkflow) obj;
