...
public abstract class BaseCmsGroup  implements Serializable {
	...
	private java.lang.Integer allowFileSize;
	private java.lang.Integer allowFileTotal;
	private java.lang.Boolean needCaptcha;
	private java.lang.Boolean needCheck;
	private java.lang.Boolean regDef;

	// collections
	private java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> viewChannels;
	private java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> contriChannels;
	...
	public java.lang.Integer getAllowFileSize() {
		return allowFileSize;
	}

	public void setAllowFileSize(java.lang.Integer allowFileSize) {
		this.allowFileSize = allowFileSize;
	}

	public java.lang.Integer getAllowFileTotal() {
		return allowFileTotal;
	}

	public void setAllowFileTotal(java.lang.Integer allowFileTotal) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> getViewChannels () {
		return viewChannels;
	}
	 ...
	 */
	public void setViewChannels (java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> viewChannels) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> getContriChannels () {
	 ...
	 */
	public void setContriChannels (java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> contriChannels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsGroup)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsGroup cmsGroup = (com.yhcrt.weihu.core.entity.CmsGroup) obj;
