...
public abstract class BaseCmsWorkflowEventUser  implements Serializable {
	...
	// many to one
	private com.yhcrt.weihu.core.entity.CmsWorkflowEvent event;
	 ...
	 */
	public com.yhcrt.weihu.core.entity.CmsWorkflowEvent getEvent () {
		return event;
	}
	 ...
	 */
	public void setEvent (com.yhcrt.weihu.core.entity.CmsWorkflowEvent event) {
		this.event = event;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsWorkflowEventUser)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsWorkflowEventUser cmsWorkflowEventUser = (com.yhcrt.weihu.core.entity.CmsWorkflowEventUser) obj;
