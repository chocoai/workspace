...
public abstract class BaseCmsUserResume  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsUserResume)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsUserResume cmsUserResume = (com.yhcrt.weihu.core.entity.CmsUserResume) obj;
