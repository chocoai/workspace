...
public abstract class BaseCmsSiteCompany  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsSiteCompany)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsSiteCompany cmsSiteCompany = (com.yhcrt.weihu.core.entity.CmsSiteCompany) obj;
