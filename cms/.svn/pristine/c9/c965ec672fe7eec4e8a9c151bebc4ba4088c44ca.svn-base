...
public abstract class BaseCmsSensitivity  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsSensitivity)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsSensitivity cmsSensitivity = (com.yhcrt.weihu.cms.entity.assist.CmsSensitivity) obj;
