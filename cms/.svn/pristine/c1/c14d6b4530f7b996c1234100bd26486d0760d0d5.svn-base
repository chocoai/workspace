...
public abstract class BaseCmsScoreGroup  implements Serializable {
	...
	// collections
	private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsScoreItem> items;
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsScoreItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsScoreItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup cmsScoreGroup = (com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup) obj;
