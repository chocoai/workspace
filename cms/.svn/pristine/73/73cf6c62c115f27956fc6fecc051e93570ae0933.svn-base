...
public abstract class BaseCmsConfigItem  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsConfigItem)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsConfigItem cmsConfigItem = (com.yhcrt.weihu.core.entity.CmsConfigItem) obj;
