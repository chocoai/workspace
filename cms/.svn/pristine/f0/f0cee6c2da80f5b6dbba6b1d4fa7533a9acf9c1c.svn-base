...
public abstract class BaseCmsWorkflowRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsWorkflowRecord)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsWorkflowRecord cmsWorkflowRecord = (com.yhcrt.weihu.core.entity.CmsWorkflowRecord) obj;
