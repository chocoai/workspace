...
import com.yhcrt.weihu.cms.manager.assist.CmsUserMenuMng;
import com.yhcrt.weihu.cms.manager.main.ContentMng;
import com.yhcrt.weihu.cms.web.AdminContextInterceptor;
...
public class WelcomeAct {
	...
	// 最新10条待审内容
	List<Content> contents = (List<Content>) contentMng.getPageByRight(null, null, user.getId(), 0, false, false,
		ContentStatus.prepared, user.getCheckStep(site.getId()), site.getId(), null, user.getId(), 0, 1, 10)
		.getList();
	List<Content> newcontents = (List<Content>) contentMng.getPageByRight(null, null, user.getId(), 0, false, false,
		ContentStatus.checked, user.getCheckStep(site.getId()), site.getId(), null, user.getId(), 0, 1, 10)
		.getList();
    ...
    /*
     * @Autowired private CmsSiteMng cmsSiteMng;
     */
