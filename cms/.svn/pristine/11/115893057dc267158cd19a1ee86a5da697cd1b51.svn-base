...
public abstract class BaseCmsSiteAccessStatistic  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessStatistic)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessStatistic cmsSiteAccessStatistic = (com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessStatistic) obj;
