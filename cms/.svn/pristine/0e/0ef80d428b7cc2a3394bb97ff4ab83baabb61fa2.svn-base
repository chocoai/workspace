...
/**
 * This is an object that contains data related to the jc_channel_txt table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_channel_txt"
 */
...
public abstract class BaseChannelTxt implements Serializable {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ChannelTxt))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ChannelTxt channelTxt = (com.yhcrt.weihu.cms.entity.main.ChannelTxt) obj;
	    if (null == this.getId() || null == channelTxt.getId())
		return false;
	    else
		return (this.getId().equals(channelTxt.getId()));
	}
    }
