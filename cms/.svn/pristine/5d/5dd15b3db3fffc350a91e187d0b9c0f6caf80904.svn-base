...
/**
 * This is an object that contains data related to the jc_model_item table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_model_item"
 */
...
public abstract class BaseCmsModelItem implements Serializable {
     ...
     */
    public BaseCmsModelItem(java.lang.Integer id, com.yhcrt.weihu.cms.entity.main.CmsModel model,
	    java.lang.String field, java.lang.String label, java.lang.Integer dataType, java.lang.Boolean single,
	    java.lang.Boolean channel, java.lang.Boolean custom, java.lang.Boolean display) {
     ...
     * 
     * @hibernate.id generator-class="identity" column="modelitem_id"
     */
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.CmsModelItem))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.CmsModelItem cmsModelItem = (com.yhcrt.weihu.cms.entity.main.CmsModelItem) obj;
	    if (null == this.getId() || null == cmsModelItem.getId())
		return false;
	    else
		return (this.getId().equals(cmsModelItem.getId()));
	}
    }
