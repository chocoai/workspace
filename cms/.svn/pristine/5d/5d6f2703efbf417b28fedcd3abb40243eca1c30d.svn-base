package com.yhcrt.weihu.core.entity.base;
...
/**
 * This is an object that contains data related to the jc_user table. Do not
...
public abstract class BaseCmsUser implements Serializable {
     ...
     */
    public BaseCmsUser(java.lang.Integer id, com.yhcrt.weihu.core.entity.CmsGroup group, java.lang.String username,
	    java.util.Date registerTime, java.lang.String registerIp, java.lang.Integer loginCount,
	    java.lang.Integer rank, java.lang.Long uploadTotal, java.lang.Integer uploadSize, java.lang.Boolean admin,
    ...
    // many to one
    private com.yhcrt.weihu.core.entity.CmsGroup group;

    private com.yhcrt.weihu.core.entity.CmsDepartment department;

    // collections
    private java.util.Map<java.lang.String, java.lang.String> attr;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsUserExt> userExtSet;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsUserSite> userSites;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsRole> roles;

    private java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> channels;

    private java.util.Set<com.yhcrt.weihu.cms.entity.main.Content> collectContents;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsMessage> sendMessages;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsMessage> receivMessages;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsJobApply> jobApplys;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsUserResume> userResumeSet;

    private java.util.Set<CmsLog> logs;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsUserMenu> menus;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEventUser> eventUsers;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowRecord> checkRecords;
     ...
     */
    public com.yhcrt.weihu.core.entity.CmsGroup getGroup() {
	return group;
    }
     ...
     *            the group_id value
     */
    public void setGroup(com.yhcrt.weihu.core.entity.CmsGroup group) {
	this.group = group;
    }

    public com.yhcrt.weihu.core.entity.CmsDepartment getDepartment() {
	return department;
    }

    public void setDepartment(com.yhcrt.weihu.core.entity.CmsDepartment department) {
     ...
     */
    public java.util.Set<com.yhcrt.weihu.core.entity.CmsUserExt> getUserExtSet() {
	return userExtSet;
    }
     ...
     */
    public void setUserExtSet(java.util.Set<com.yhcrt.weihu.core.entity.CmsUserExt> userExtSet) {
     ...
     */
    public java.util.Set<com.yhcrt.weihu.core.entity.CmsUserSite> getUserSites() {
	return userSites;
    }
     ...
     *            the userSites value
     */
    public void setUserSites(java.util.Set<com.yhcrt.weihu.core.entity.CmsUserSite> userSites) {
     ...
     */
    public java.util.Set<com.yhcrt.weihu.core.entity.CmsRole> getRoles() {
	return roles;
    }
     ...
     *            the roles value
     */
    public void setRoles(java.util.Set<com.yhcrt.weihu.core.entity.CmsRole> roles) {
	this.roles = roles;
    }
    ...
    public java.util.Set<com.yhcrt.weihu.cms.entity.main.Content> getCollectContents() {
	return collectContents;
    }

    public void setCollectContents(java.util.Set<com.yhcrt.weihu.cms.entity.main.Content> collectContents) {
	this.collectContents = collectContents;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsMessage> getSendMessages() {
	return sendMessages;
    }

    public void setSendMessages(java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsMessage> sendMessages) {
	this.sendMessages = sendMessages;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsMessage> getReceivMessages() {
	return receivMessages;
    }

    public void setReceivMessages(java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsMessage> receivMessages) {
	this.receivMessages = receivMessages;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> getSendReceiverMessages() {
	return sendReceiverMessages;
    }

    public void setSendReceiverMessages(
	    java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages) {
	this.sendReceiverMessages = sendReceiverMessages;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> getReceivReceiverMessages() {
	return receivReceiverMessages;
    }

    public void setReceivReceiverMessages(
	    java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages) {
    ...
    public java.util.Set<com.yhcrt.weihu.core.entity.CmsUserResume> getUserResumeSet() {
	return userResumeSet;
    }

    public void setUserResumeSet(java.util.Set<com.yhcrt.weihu.core.entity.CmsUserResume> userResumeSet) {
    ...
    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsUserMenu> getMenus() {
	return menus;
    }

    public void setMenus(java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsUserMenu> menus) {
	this.menus = menus;
    }

    public java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEventUser> getEventUsers() {
	return eventUsers;
    }

    public void setEventUsers(java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEventUser> eventUsers) {
	this.eventUsers = eventUsers;
    }

    public java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowRecord> getCheckRecords() {
	return checkRecords;
    }

    public void setCheckRecords(java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowRecord> checkRecords) {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsUser))
	    return false;
	else {
	    com.yhcrt.weihu.core.entity.CmsUser cmsUser = (com.yhcrt.weihu.core.entity.CmsUser) obj;
	    if (null == this.getId() || null == cmsUser.getId())
		return false;
	    else
		return (this.getId().equals(cmsUser.getId()));
	}
    }
