...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	public BaseCmsScoreItem (
		...
		com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup group,
	...
	// many to one
	private com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.yhcrt.weihu.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsScoreItem)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsScoreItem cmsScoreItem = (com.yhcrt.weihu.cms.entity.assist.CmsScoreItem) obj;
