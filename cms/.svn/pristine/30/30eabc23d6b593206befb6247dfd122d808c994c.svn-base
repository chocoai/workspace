...
public abstract class BaseCmsAcquisitionHistory  implements Serializable {
	...
	// many to one
	private com.yhcrt.weihu.cms.entity.assist.CmsAcquisition acquisition;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsAcquisition getAcquisition () {
		return acquisition;
	}
	 ...
	 */
	public void setAcquisition (com.yhcrt.weihu.cms.entity.assist.CmsAcquisition acquisition) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsAcquisitionHistory)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsAcquisitionHistory cmsAcquisitionHistory = (com.yhcrt.weihu.cms.entity.assist.CmsAcquisitionHistory) obj;
