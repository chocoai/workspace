package com.yhcrt.weihu.plug.weixin.dao.impl;
...
import com.yhcrt.weihu.plug.weixin.dao.WeixinMessageDao;
...
public class WeixinMessageDaoImpl extends HibernateBaseDao<WeixinMessage, Integer> implements WeixinMessageDao {
	...
	public WeixinMessage findByNumber(String number,Integer siteId){
		Finder f = Finder.create(" from WeixinMessage bean where bean.site.id=:siteId and bean.number=:number order by bean.id");
