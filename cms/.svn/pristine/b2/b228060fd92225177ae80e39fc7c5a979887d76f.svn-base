...
public abstract class BaseCmsDepartment  implements Serializable {
	...
	private com.yhcrt.weihu.core.entity.CmsDepartment parent;

	// collections
	private java.util.Set<com.yhcrt.weihu.core.entity.CmsDepartment> child;
	private java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> channels;
	private java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> controlChannels;
	private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs;
	...
	public com.yhcrt.weihu.core.entity.CmsDepartment getParent() {
		return parent;
	}

	public void setParent(com.yhcrt.weihu.core.entity.CmsDepartment parent) {
		this.parent = parent;
	}

	public java.util.Set<com.yhcrt.weihu.core.entity.CmsDepartment> getChild() {
		return child;
	}

	public void setChild(
			java.util.Set<com.yhcrt.weihu.core.entity.CmsDepartment> child) {
		this.child = child;
	}
	/**
	...
	public java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> getControlChannels() {
		return controlChannels;
	}

	public void setControlChannels(
			java.util.Set<com.yhcrt.weihu.cms.entity.main.Channel> controlChannels) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsGuestbookCtg> getGuestBookCtgs () {
	 ...
	 */
	public void setGuestBookCtgs (java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsDepartment)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsDepartment cmsDepartment = (com.yhcrt.weihu.core.entity.CmsDepartment) obj;
