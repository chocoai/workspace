...
public abstract class BaseCmsSite implements Serializable {
     ...
     */
    public BaseCmsSite(java.lang.Integer id, com.yhcrt.weihu.core.entity.CmsConfig config, java.lang.String domain,
	    java.lang.String path, java.lang.String name, java.lang.String protocol, java.lang.String dynamicSuffix,
	    java.lang.String staticSuffix, java.lang.Boolean indexToRoot, java.lang.Boolean staticIndex,
	    java.lang.String localeAdmin, java.lang.String localeFront, java.lang.String tplSolution,
	    java.lang.Byte finalStep, java.lang.Byte afterCheck, java.lang.Boolean relativePath,
    ...
    // many to one
    private com.yhcrt.weihu.core.entity.Ftp uploadFtp;

    private com.yhcrt.weihu.core.entity.Ftp syncPageFtp;

    private com.yhcrt.weihu.core.entity.CmsConfig config;

    // one to one
    private com.yhcrt.weihu.core.entity.CmsSiteCompany siteCompany;

    private com.yhcrt.weihu.core.entity.CmsSite parent;
    ...
    private java.util.Set<CmsSite> child;

    private java.util.Set<com.yhcrt.weihu.core.entity.CmsUserSite> userSites;

    private java.util.Set<CmsLog> logs;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessCount> accessCounts;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccess> accesses;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessPages> accessPages;

    private java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics;
     ...
     */
    public com.yhcrt.weihu.core.entity.Ftp getUploadFtp() {
	return uploadFtp;
    }
     ...
     */
    public void setUploadFtp(com.yhcrt.weihu.core.entity.Ftp uploadFtp) {
	this.uploadFtp = uploadFtp;
    }

    public com.yhcrt.weihu.core.entity.Ftp getSyncPageFtp() {
	return syncPageFtp;
    }

    public void setSyncPageFtp(com.yhcrt.weihu.core.entity.Ftp syncPageFtp) {
     ...
     */
    public com.yhcrt.weihu.core.entity.CmsConfig getConfig() {
	return config;
    }
     ...
     *            the config_id value
     */
    public void setConfig(com.yhcrt.weihu.core.entity.CmsConfig config) {
	this.config = config;
    }

    public com.yhcrt.weihu.core.entity.CmsSiteCompany getSiteCompany() {
	return siteCompany;
    }

    public void setSiteCompany(com.yhcrt.weihu.core.entity.CmsSiteCompany siteCompany) {
	this.siteCompany = siteCompany;
    }

    public com.yhcrt.weihu.core.entity.CmsSite getParent() {
	return parent;
    }

    public void setParent(com.yhcrt.weihu.core.entity.CmsSite parent) {
	this.parent = parent;
    }
    ...
    public java.util.Set<CmsSite> getChild() {
	return child;
    }

    public void setChild(java.util.Set<CmsSite> child) {
	this.child = child;
    }
    ...
    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessCount> getAccessCounts() {
	return accessCounts;
    }

    public void setAccessCounts(java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessCount> accessCounts) {
	this.accessCounts = accessCounts;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccess> getAccesses() {
	return accesses;
    }

    public void setAccesses(java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccess> accesses) {
	this.accesses = accesses;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessPages> getAccessPages() {
	return accessPages;
    }

    public void setAccessPages(java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessPages> accessPages) {
	this.accessPages = accessPages;
    }

    public java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessStatistic> getAccessStatistics() {
	return accessStatistics;
    }

    public void setAccessStatistics(
	    java.util.Set<com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics) {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsSite))
	    return false;
	else {
	    com.yhcrt.weihu.core.entity.CmsSite cmsSite = (com.yhcrt.weihu.core.entity.CmsSite) obj;
