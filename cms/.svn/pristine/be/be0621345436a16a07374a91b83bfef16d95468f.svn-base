...
public abstract class BaseCmsSiteAccessCount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessCount)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessCount cmsSiteAccessCount = (com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessCount) obj;
