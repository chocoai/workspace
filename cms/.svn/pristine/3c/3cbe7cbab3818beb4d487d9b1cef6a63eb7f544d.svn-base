...
public abstract class BaseCmsSearchWords  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsSearchWords)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsSearchWords cmsSearchWords = (com.yhcrt.weihu.cms.entity.assist.CmsSearchWords) obj;
