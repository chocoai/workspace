...
/**
 * This is an object that contains data related to the jc_channel_ext table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_channel_ext"
 */
...
public abstract class BaseChannelExt implements Serializable {
     ...
     */
    public BaseChannelExt(java.lang.Integer id, java.lang.String name, java.lang.Boolean staticChannel,
    ...
    private java.lang.String tplMobileChannel;
    ...
    public java.lang.String getTplMobileChannel() {
	return tplMobileChannel;
    }

    public void setTplMobileChannel(java.lang.String tplMobileChannel) {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ChannelExt))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ChannelExt channelExt = (com.yhcrt.weihu.cms.entity.main.ChannelExt) obj;
