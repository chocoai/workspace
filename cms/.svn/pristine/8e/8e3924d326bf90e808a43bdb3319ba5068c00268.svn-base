...
public abstract class BaseCmsTask  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsTask)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsTask cmsTask = (com.yhcrt.weihu.cms.entity.assist.CmsTask) obj;
