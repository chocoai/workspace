...
/**
 * This is an object that contains data related to the jc_content_doc table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_content_doc"
 */
...
public abstract class BaseContentDoc implements Serializable {
     ...
     */
    public BaseContentDoc(java.lang.Integer id, java.lang.String path, java.lang.Integer grain,
	    java.lang.Integer downNeed, java.lang.Boolean isOpen, java.lang.String fileSuffix,
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ContentDoc))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ContentDoc contentDoc = (com.yhcrt.weihu.cms.entity.main.ContentDoc) obj;
	    if (null == this.getId() || null == contentDoc.getId())
		return false;
	    else
		return (this.getId().equals(contentDoc.getId()));
	}
    }
