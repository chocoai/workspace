...
public abstract class BaseCmsJobApply  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsJobApply)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsJobApply cmsJobApply = (com.yhcrt.weihu.cms.entity.assist.CmsJobApply) obj;
