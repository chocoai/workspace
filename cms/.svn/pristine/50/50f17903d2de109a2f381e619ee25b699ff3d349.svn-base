...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	public BaseCmsVoteItem (
		...
		com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic topic,
	...
	// many to one
	private com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic topic;
	private com.yhcrt.weihu.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.yhcrt.weihu.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.yhcrt.weihu.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.yhcrt.weihu.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsVoteItem)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsVoteItem cmsVoteItem = (com.yhcrt.weihu.cms.entity.assist.CmsVoteItem) obj;
