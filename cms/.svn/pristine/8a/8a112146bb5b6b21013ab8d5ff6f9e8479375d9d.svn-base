 ...
 *
 * @hibernate.class table="jc_channel_count"
 */
...
public abstract class BaseChannelCount implements Serializable {
     ...
     */
    public BaseChannelCount(java.lang.Integer id, java.lang.Integer views, java.lang.Integer viewsMonth,
	    java.lang.Integer viewsWeek, java.lang.Integer viewsDay) {
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ChannelCount))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ChannelCount channelCount = (com.yhcrt.weihu.cms.entity.main.ChannelCount) obj;
	    if (null == this.getId() || null == channelCount.getId())
		return false;
	    else
		return (this.getId().equals(channelCount.getId()));
	}
    }
