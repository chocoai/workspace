 ...
 * 专题列表标签
 */
public class CmsTTPageDirective implements TemplateDirectiveModel {
	/**
	 * 模板名称
	 */
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Pagination page = cmsTTMng.getPage(getSiteId(params),
				getTypeId(params),getIsAdmin(params),getDemand(params),null, getRecommend(params), getChecked(params),
