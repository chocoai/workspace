...
public abstract class BaseCmsWorkflowEvent  implements Serializable {
	...
	private com.yhcrt.weihu.core.entity.CmsUser initiator;

	// collections
	private java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowRecord> records;
	private java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEventUser> users;
	 ...
	 */
	public com.yhcrt.weihu.core.entity.CmsUser getInitiator () {
		return initiator;
	}
	 ...
	 */
	public void setInitiator (com.yhcrt.weihu.core.entity.CmsUser initiator) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowRecord> records) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEventUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.yhcrt.weihu.core.entity.CmsWorkflowEventUser> users) {
		this.users = users;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsWorkflowEvent)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsWorkflowEvent cmsWorkflowEvent = (com.yhcrt.weihu.core.entity.CmsWorkflowEvent) obj;
