...
public abstract class BaseCmsUserMenu  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsUserMenu)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsUserMenu cmsUserMenu = (com.yhcrt.weihu.cms.entity.assist.CmsUserMenu) obj;
