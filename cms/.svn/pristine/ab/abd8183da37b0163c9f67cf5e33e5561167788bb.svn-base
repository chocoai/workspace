...
public abstract class BaseCmsScoreRecord  implements Serializable {
	...
	public BaseCmsScoreRecord (
		...
		com.yhcrt.weihu.cms.entity.assist.CmsScoreItem item,
	...
	// many to one
	private com.yhcrt.weihu.cms.entity.assist.CmsScoreItem item;
	 ...
	 */
	public com.yhcrt.weihu.cms.entity.assist.CmsScoreItem getItem () {
		return item;
	}
	 ...
	 */
	public void setItem (com.yhcrt.weihu.cms.entity.assist.CmsScoreItem item) {
		this.item = item;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsScoreRecord)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsScoreRecord cmsScoreRecord = (com.yhcrt.weihu.cms.entity.assist.CmsScoreRecord) obj;
