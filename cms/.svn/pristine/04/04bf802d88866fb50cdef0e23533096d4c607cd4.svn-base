 ...
 *
 * @hibernate.class table="jc_third_account"
 */
...
public abstract class BaseCmsThirdAccount implements Serializable {
     ...
     */
    public BaseCmsThirdAccount(java.lang.Long id, java.lang.String accountKey, java.lang.String username,
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.CmsThirdAccount))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.CmsThirdAccount cmsThirdAccount = (com.yhcrt.weihu.cms.entity.main.CmsThirdAccount) obj;
	    if (null == this.getId() || null == cmsThirdAccount.getId())
		return false;
	    else
		return (this.getId().equals(cmsThirdAccount.getId()));
	}
    }
