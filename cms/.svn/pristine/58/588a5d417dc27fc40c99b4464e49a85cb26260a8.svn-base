...
/**
 * This is an object that contains data related to the jc_content_type table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_content_type"
 */
...
public abstract class BaseContentType implements Serializable {
     ...
     */
    public BaseContentType(java.lang.Integer id, java.lang.String name, java.lang.Boolean hasImage,
	...
	if (null == obj)
	    return false;
	if (!(obj instanceof com.yhcrt.weihu.cms.entity.main.ContentType))
	    return false;
	else {
	    com.yhcrt.weihu.cms.entity.main.ContentType contentType = (com.yhcrt.weihu.cms.entity.main.ContentType) obj;
	    if (null == this.getId() || null == contentType.getId())
		return false;
	    else
		return (this.getId().equals(contentType.getId()));
	}
    }
