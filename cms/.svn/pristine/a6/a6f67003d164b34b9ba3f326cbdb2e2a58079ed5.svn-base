...
public abstract class BaseCmsWebservice  implements Serializable {
	...
	// collections
	private java.util.List<com.yhcrt.weihu.cms.entity.assist.CmsWebserviceParam> params;
	 ...
	 */
	public java.util.List<com.yhcrt.weihu.cms.entity.assist.CmsWebserviceParam> getParams () {
		return params;
	}
	 ...
	 */
	public void setParams (java.util.List<com.yhcrt.weihu.cms.entity.assist.CmsWebserviceParam> params) {
		this.params = params;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsWebservice)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsWebservice cmsWebservice = (com.yhcrt.weihu.cms.entity.assist.CmsWebservice) obj;
