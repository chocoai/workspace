...
public abstract class BaseWeixin  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.plug.weixin.entity.Weixin)) return false;
		else {
			com.yhcrt.weihu.plug.weixin.entity.Weixin weixin = (com.yhcrt.weihu.plug.weixin.entity.Weixin) obj;
