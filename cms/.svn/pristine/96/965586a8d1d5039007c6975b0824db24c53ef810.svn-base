...
public abstract class BaseCmsDictionary  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.CmsDictionary)) return false;
		else {
			com.yhcrt.weihu.core.entity.CmsDictionary cmsDictionary = (com.yhcrt.weihu.core.entity.CmsDictionary) obj;
