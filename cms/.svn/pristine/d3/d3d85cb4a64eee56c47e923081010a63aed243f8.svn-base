...
import static com.yhcrt.weihu.cms.Constants.LIBRARY_PATH;
import static com.yhcrt.weihu.cms.Constants.RES_PATH;
import static com.yhcrt.weihu.cms.Constants.TPLDIR_INDEX;
import static com.yhcrt.weihu.cms.Constants.TPL_BASE;
import static com.yhcrt.weihu.cms.Constants.TPL_SUFFIX;
import static com.yhcrt.weihu.cms.Constants.UPLOAD_PATH;
import static com.yhcrt.weihu.common.web.Constants.ADMIN_SUFFIX;
...
import com.yhcrt.weihu.core.entity.base.BaseCmsSite;
...
public class CmsSite extends BaseCmsSite {
	...
	public String getAdminUrl() {
		StringBuilder url = new StringBuilder();
			url.append(getUrlDynamic());
			if(getConfig().getInsideSite()){
				url.append(getAccessPath()).append(SPT);
			}
	...
	public CmsSite (
		...
		com.yhcrt.weihu.core.entity.CmsConfig config,
