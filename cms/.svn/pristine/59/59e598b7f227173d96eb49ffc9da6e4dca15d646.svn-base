...
public abstract class BaseCmsSiteAccessPages  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessPages)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessPages cmsSiteAccessPages = (com.yhcrt.weihu.cms.entity.assist.CmsSiteAccessPages) obj;
