 ...
 * 分页标签
 */
public class CmsBaoLiaoPageDirective extends AbstractCmsBaoLiaoDirective {
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "baoliao_page";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Pagination page = cmsBaoLiaoMng.getPage(getSiteId(params),
