...
public class Constants {
	 ...
	 * 换客模版
	 */
	public static final String TPLDIR_EXCHANGE = "exchange";
	/**
	 * 留言模板
	 */
	 ...
	 * 上传路径
	 */
	public static final String UPLOAD_PATH = "/up_file/dcw/";
	/**
	 * 截图路径
	 */
	 ...
	 * 配置文件
	 */
	public static String CMS_CONFIG = "/WEB-INF/config/cms/cms.properties";
	/**
	 * 插件路径
	 */
