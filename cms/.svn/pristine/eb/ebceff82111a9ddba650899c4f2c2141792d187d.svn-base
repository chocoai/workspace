...
public abstract class BaseUnifiedUser  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.UnifiedUser)) return false;
		else {
			com.yhcrt.weihu.core.entity.UnifiedUser unifiedUser = (com.yhcrt.weihu.core.entity.UnifiedUser) obj;
