...
import com.yhcrt.weihu.cms.dao.assist.CmsAcquisitionDao;
import com.yhcrt.weihu.cms.entity.assist.CmsAcquisition;
import com.yhcrt.weihu.cms.entity.assist.CmsAcquisitionHistory;
import com.yhcrt.weihu.cms.entity.assist.CmsAcquisitionTemp;
import com.yhcrt.weihu.cms.entity.assist.CmsAcquisition.AcquisitionResultType;
...
import com.yhcrt.weihu.cms.manager.assist.CmsAcquisitionHistoryMng;
...
public class CmsAcquisitionMngImpl implements CmsAcquisitionMng,
	...
	public Content saveContent(String title, String txt, String origin,
		...
		ctxt.setTxt(txt);
		Content content = contentMng.save(c, cext, ctxt,null, null, null, null,null,
