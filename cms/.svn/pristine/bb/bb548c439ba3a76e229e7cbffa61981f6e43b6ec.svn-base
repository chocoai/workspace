...
public abstract class BaseCmsWorkflowNode  implements Serializable {
	...
	// many to one
	private com.yhcrt.weihu.core.entity.CmsRole role;
	 ...
	 */
	public com.yhcrt.weihu.core.entity.CmsRole getRole () {
		return role;
	}
	 ...
	 */
	public void setRole (com.yhcrt.weihu.core.entity.CmsRole role) {
		this.role = role;
	}
