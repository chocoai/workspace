...
public abstract class BaseCmsFile  implements Serializable {
	...
	private com.yhcrt.weihu.cms.entity.assist.CmsTT TT;
	...
	public com.yhcrt.weihu.cms.entity.assist.CmsTT getTT() {
		return TT;
	}

	public void setTT(com.yhcrt.weihu.cms.entity.assist.CmsTT tT) {
		TT = tT;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsFile)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsFile cmsFile = (com.yhcrt.weihu.cms.entity.assist.CmsFile) obj;
