...
public abstract class BaseCmsVoteRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.cms.entity.assist.CmsVoteRecord)) return false;
		else {
			com.yhcrt.weihu.cms.entity.assist.CmsVoteRecord cmsVoteRecord = (com.yhcrt.weihu.cms.entity.assist.CmsVoteRecord) obj;
