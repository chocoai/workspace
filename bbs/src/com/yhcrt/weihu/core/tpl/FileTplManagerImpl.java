package com.yhcrt.weihu.core.tpl;
...
import com.yhcrt.weihu.core.tpl.FileTpl;
import com.yhcrt.weihu.core.tpl.FileTplManagerImpl;
...
public class FileTplManagerImpl implements TplManager {
	...
	File f = new File(realPathResolver.get(path), file.getOriginalFilename());
	try {
	    file.transferTo(f);
