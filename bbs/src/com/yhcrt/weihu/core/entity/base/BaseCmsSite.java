...
public abstract class BaseCmsSite implements Serializable {
	 ...
	 */
	public BaseCmsSite(java.lang.Integer id,
			com.yhcrt.weihu.core.entity.CmsConfig config, java.lang.String domain,
	...
	private com.yhcrt.weihu.bbs.entity.BbsCreditExchange creditExchange;
	...
	public com.yhcrt.weihu.bbs.entity.BbsCreditExchange getCreditExchange() {
		return creditExchange;
	}

	public void setCreditExchange(
			com.yhcrt.weihu.bbs.entity.BbsCreditExchange creditExchange) {
