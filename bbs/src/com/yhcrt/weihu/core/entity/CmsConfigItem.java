...
import com.yhcrt.weihu.core.entity.base.BaseCmsConfigItem;
...
public class CmsConfigItem extends BaseCmsConfigItem {
     ...
     */
    public CmsConfigItem(java.lang.Integer id, com.yhcrt.weihu.core.entity.CmsConfig config,
	    java.lang.String field, java.lang.String label, java.lang.Integer priority,
	    java.lang.Integer dataType, boolean required, java.lang.Integer category) {

	super(id, config, field, label, priority, dataType, required, category);
    }
