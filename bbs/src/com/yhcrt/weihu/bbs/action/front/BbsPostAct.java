...
import static com.yhcrt.weihu.bbs.Constants.TPLDIR_POST;
...
import com.yhcrt.weihu.bbs.action.front.BbsPostAct;
...
public class BbsPostAct {
	...
	public String save(BbsPost bean, Integer topicId, Integer postTypeId,String title,
			String content,Integer upPostId,
		...
		bean = manager.reply(user.getId(), site.getId(), topicId,postTypeId, title,
				content, ip, multipartRequest.getFiles("attachment"), code,upPostId);
