...
public abstract class BaseBbsWebserviceCallRecord  implements Serializable {
	...
	public BaseBbsWebserviceCallRecord (
		...
		com.yhcrt.weihu.bbs.entity.BbsWebserviceAuth auth,
	...
	// many to one
	private com.yhcrt.weihu.bbs.entity.BbsWebserviceAuth auth;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsWebserviceAuth getAuth () {
		return auth;
	}
	 ...
	 */
	public void setAuth (com.yhcrt.weihu.bbs.entity.BbsWebserviceAuth auth) {
		this.auth = auth;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsWebserviceCallRecord)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsWebserviceCallRecord bbsWebserviceCallRecord = (com.yhcrt.weihu.bbs.entity.BbsWebserviceCallRecord) obj;
