...
public abstract class BaseBbsPostType  implements Serializable {
	...
	private com.yhcrt.weihu.bbs.entity.BbsPostType parent;

	// collections
	private java.util.Set<com.yhcrt.weihu.bbs.entity.BbsPostType> childs;
	private java.util.Set<com.yhcrt.weihu.bbs.entity.BbsUserGroup> groups;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsPostType getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.yhcrt.weihu.bbs.entity.BbsPostType parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.bbs.entity.BbsPostType> getChilds () {
		return childs;
	}
	 ...
	 */
	public void setChilds (java.util.Set<com.yhcrt.weihu.bbs.entity.BbsPostType> childs) {
		this.childs = childs;
	}
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.bbs.entity.BbsUserGroup> getGroups () {
		return groups;
	}
	 ...
	 */
	public void setGroups (java.util.Set<com.yhcrt.weihu.bbs.entity.BbsUserGroup> groups) {
		this.groups = groups;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsPostType)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsPostType bbsPostType = (com.yhcrt.weihu.bbs.entity.BbsPostType) obj;
