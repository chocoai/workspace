...
public abstract class BaseBbsReportExt  implements Serializable {
	...
	public BaseBbsReportExt (
		...
		com.yhcrt.weihu.bbs.entity.BbsUser reportUser,
		com.yhcrt.weihu.bbs.entity.BbsReport report,
	...
	// many to one
	private com.yhcrt.weihu.bbs.entity.BbsUser reportUser;
	private com.yhcrt.weihu.bbs.entity.BbsReport report;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsUser getReportUser () {
		return reportUser;
	}
	 ...
	 */
	public void setReportUser (com.yhcrt.weihu.bbs.entity.BbsUser reportUser) {
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsReport getReport () {
		return report;
	}
	 ...
	 */
	public void setReport (com.yhcrt.weihu.bbs.entity.BbsReport report) {
		this.report = report;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsReportExt)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsReportExt bbsReportExt = (com.yhcrt.weihu.bbs.entity.BbsReportExt) obj;
