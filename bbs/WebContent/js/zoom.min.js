(function(e) {
    function u(u) {
        ...
        n.html(l).delay(200).addClass("loading");
        l.load(c).attr("src", f);
        i = a
    }
    function a() {
        var t = i.parent("li").prev();
        if (t.length == 0) t = e(".album_pic li:last-child");
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent("li").next();
        if (t.length == 0) t = e(".album_pic li:first-child");
    ...
    o = e(window).height(); (function() {
        ...
        if (e(".album_pic li a").length == 1) 
        	e(".album_pic li a")[0].className = "zoom";
        e(".zoom, .album_pic li a").on("click", u)
    })(); (function() {
