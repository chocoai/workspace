...
import static com.yhcrt.weihu.bbs.Constants.TPL_BASE;
import static com.yhcrt.weihu.bbs.Constants.UPLOAD_PATH;
import static com.yhcrt.weihu.common.web.Constants.DEFAULT;
