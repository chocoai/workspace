...
public abstract class BaseBbsCategory  implements Serializable {
	...
	// collections
	private java.util.Set<com.yhcrt.weihu.bbs.entity.BbsForum> forums;
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.bbs.entity.BbsForum> getForums () {
		return forums;
	}
	 ...
	 */
	public void setForums (java.util.Set<com.yhcrt.weihu.bbs.entity.BbsForum> forums) {
		this.forums = forums;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsCategory)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsCategory bbsCategory = (com.yhcrt.weihu.bbs.entity.BbsCategory) obj;
