...
public abstract class BaseBbsCreditExchange  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsCreditExchange)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsCreditExchange bbsCreditExchange = (com.yhcrt.weihu.bbs.entity.BbsCreditExchange) obj;
