...
public abstract class BaseBbsUserActiveLevel  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsUserActiveLevel)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsUserActiveLevel bbsUserActiveLevel = (com.yhcrt.weihu.bbs.entity.BbsUserActiveLevel) obj;
