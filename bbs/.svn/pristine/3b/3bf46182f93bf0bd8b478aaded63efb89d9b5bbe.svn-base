...
public abstract class BaseBbsMessageReply  implements Serializable {
	...
	private java.lang.Boolean isnotification;

	// many to one
	private com.yhcrt.weihu.bbs.entity.BbsMessage message;
	private com.yhcrt.weihu.bbs.entity.BbsUser sender;
	private com.yhcrt.weihu.bbs.entity.BbsUser receiver;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsMessage getMessage () {
		return message;
	}
	 ...
	 */
	public void setMessage (com.yhcrt.weihu.bbs.entity.BbsMessage message) {
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsUser getSender () {
		return sender;
	}
	 ...
	 */
	public void setSender (com.yhcrt.weihu.bbs.entity.BbsUser sender) {
		this.sender = sender;
	}
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsUser getReceiver () {
		return receiver;
	}
	 ...
	 */
	public void setReceiver (com.yhcrt.weihu.bbs.entity.BbsUser receiver) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsMessageReply)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsMessageReply bbsMessageReply = (com.yhcrt.weihu.bbs.entity.BbsMessageReply) obj;
	...
	public java.lang.Boolean getIsnotification() {
		return isnotification;
	}

	public void setIsnotification(java.lang.Boolean isnotification) {
