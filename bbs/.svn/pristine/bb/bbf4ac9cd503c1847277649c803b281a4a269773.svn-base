...
public abstract class BaseBbsVoteItem  implements Serializable {
	...
	public BaseBbsVoteItem (
		...
		com.yhcrt.weihu.bbs.entity.BbsVoteTopic topic,
	...
	// many to one
	private com.yhcrt.weihu.bbs.entity.BbsVoteTopic topic;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.yhcrt.weihu.bbs.entity.BbsVoteTopic topic) {
		this.topic = topic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsVoteItem)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsVoteItem bbsVoteItem = (com.yhcrt.weihu.bbs.entity.BbsVoteItem) obj;
