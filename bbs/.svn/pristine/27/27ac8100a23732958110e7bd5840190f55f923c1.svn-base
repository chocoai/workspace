...
public abstract class BaseCmsFriendlinkCtg  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg cmsFriendlinkCtg = (com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg) obj;
