...
public abstract class BaseBbsGrade  implements Serializable {
	...
	public BaseBbsGrade (
		...
		com.yhcrt.weihu.bbs.entity.BbsUser grader) {
	...
	// many to one
	private com.yhcrt.weihu.bbs.entity.BbsPost post;
	private com.yhcrt.weihu.bbs.entity.BbsUser grader;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsPost getPost () {
		return post;
	}
	 ...
	 */
	public void setPost (com.yhcrt.weihu.bbs.entity.BbsPost post) {
		this.post = post;
	}
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsUser getGrader () {
		return grader;
	}
	 ...
	 */
	public void setGrader (com.yhcrt.weihu.bbs.entity.BbsUser grader) {
		this.grader = grader;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsGrade)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsGrade bbsGrade = (com.yhcrt.weihu.bbs.entity.BbsGrade) obj;
