...
public abstract class BaseCmsFriendlink  implements Serializable {
	...
	public BaseCmsFriendlink (
		...
		com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg category,
	...
	// many to one
	private com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg category;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg getCategory () {
		return category;
	}
	 ...
	 */
	public void setCategory (com.yhcrt.weihu.bbs.entity.CmsFriendlinkCtg category) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.CmsFriendlink)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.CmsFriendlink cmsFriendlink = (com.yhcrt.weihu.bbs.entity.CmsFriendlink) obj;
