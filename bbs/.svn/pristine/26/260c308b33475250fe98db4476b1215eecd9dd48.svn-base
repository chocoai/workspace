package com.yhcrt.weihu.common.web.freemarker;
...
import com.yhcrt.weihu.common.web.freemarker.MustBooleanException;
import com.yhcrt.weihu.common.web.freemarker.MustDateException;
import com.yhcrt.weihu.common.web.freemarker.MustNumberException;
import com.yhcrt.weihu.common.web.freemarker.MustSplitNumberException;
import com.yhcrt.weihu.common.web.freemarker.MustStringException;
import com.yhcrt.weihu.common.web.springmvc.DateTypeEditor;
...
public abstract class DirectiveUtils {
     ...
     */
    public static Map<String, TemplateModel> addParamsToVariable(Environment env,
	...
	if (ctx instanceof AdapterTemplateModel) {
	    ...
	    throw new TemplateModelException("RequestContext '"
		    + SPRING_MACRO_REQUEST_CONTEXT_ATTRIBUTE + "' not found in DataModel.");
	}
    }
