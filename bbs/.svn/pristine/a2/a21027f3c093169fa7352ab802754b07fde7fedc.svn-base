package com.yhcrt.weihu.common.image;
...
import com.yhcrt.weihu.common.image.MagickImageScale;
import com.yhcrt.weihu.common.image.ImageUtils.Position;
...
public class MagickImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		MagickImageScale.resizeFix(
				new File("test/com/yhcrt/weihu/common/util/1.bmp"), new File(
						"test/com/yhcrt/weihu/common/util/1-n-3.bmp"), 310, 310, 50,
				50, 320, 320);
