...
public abstract class BaseBbsMemberMagic  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsMemberMagic)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsMemberMagic bbsMemberMagic = (com.yhcrt.weihu.bbs.entity.BbsMemberMagic) obj;
