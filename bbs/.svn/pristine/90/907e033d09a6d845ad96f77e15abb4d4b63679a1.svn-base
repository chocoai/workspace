 ...
 * under the License.
 */
package com.yhcrt.weihu.core.security;
 ...
 * @since 0.9
 */
public class BbsCredentialsMatcher extends SimpleCredentialsMatcher {
     ...
     * @since 1.1
     */
    public BbsCredentialsMatcher(String hashAlgorithmName) {
        this();
    ...
    public boolean doCredentialsMatch(AuthenticationToken token, AuthenticationInfo info) {
        ...
        char[] rawPass=(char[]) token.getCredentials();
        String encodePass=encodePassword(String.valueOf(rawPass), salt);
        return equals(encodePass, accountCredentials);
    }
	...
	public String encryptPassword(Object plaintextPassword)
		...
		return encodePassword((String)plaintextPassword, salt);
	}

	public boolean passwordsMatch(Object submittedPlaintext, String encrypted) {
		return encrypted.equals(encryptPassword((String)submittedPlaintext));
	}
	...
	public String encodePassword(String rawPass, String salt) {
		...
		return new String(org.apache.commons.codec.binary.Hex.encodeHex(digest));
	}
