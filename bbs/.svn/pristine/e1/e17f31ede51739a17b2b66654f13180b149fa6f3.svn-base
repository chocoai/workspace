...
public abstract class BaseBbsWebservice  implements Serializable {
	...
	// collections
	private java.util.List<com.yhcrt.weihu.bbs.entity.BbsWebserviceParam> params;
	 ...
	 */
	public java.util.List<com.yhcrt.weihu.bbs.entity.BbsWebserviceParam> getParams () {
		return params;
	}
	 ...
	 */
	public void setParams (java.util.List<com.yhcrt.weihu.bbs.entity.BbsWebserviceParam> params) {
		this.params = params;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsWebservice)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsWebservice bbsWebservice = (com.yhcrt.weihu.bbs.entity.BbsWebservice) obj;
