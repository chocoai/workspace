...
public abstract class BaseBbsUserOnline implements Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsUserOnline))
			return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsUserOnline bbsUserOnline = (com.yhcrt.weihu.bbs.entity.BbsUserOnline) obj;
