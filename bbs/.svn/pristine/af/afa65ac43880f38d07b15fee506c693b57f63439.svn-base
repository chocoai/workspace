...
public abstract class BaseAuthentication  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.core.entity.Authentication)) return false;
		else {
			com.yhcrt.weihu.core.entity.Authentication authentication = (com.yhcrt.weihu.core.entity.Authentication) obj;
