...
public abstract class BaseBbsVoteRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsVoteRecord)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsVoteRecord bbsVoteRecord = (com.yhcrt.weihu.bbs.entity.BbsVoteRecord) obj;
