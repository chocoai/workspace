...
public abstract class BaseBbsForum implements Serializable {
	...
	private com.yhcrt.weihu.bbs.entity.BbsCategory category;
	private com.yhcrt.weihu.core.entity.CmsSite site;

	// collections
	private java.util.Set<com.yhcrt.weihu.bbs.entity.BbsPostType> postTypes;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsCategory getCategory() {
		return category;
	}
	 ...
	 */
	public void setCategory(com.yhcrt.weihu.bbs.entity.BbsCategory category) {
	...
	public java.util.Set<com.yhcrt.weihu.bbs.entity.BbsPostType> getPostTypes() {
		return postTypes;
	}

	public void setPostTypes(
			java.util.Set<com.yhcrt.weihu.bbs.entity.BbsPostType> postTypes) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsForum))
			return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsForum bbsForum = (com.yhcrt.weihu.bbs.entity.BbsForum) obj;
