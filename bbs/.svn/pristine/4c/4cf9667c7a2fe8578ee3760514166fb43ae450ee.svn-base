...
public abstract class BaseBbsReport  implements Serializable {
	...
	// many to one
	private com.yhcrt.weihu.bbs.entity.BbsUser processUser;

	// collections
	private java.util.Set<com.yhcrt.weihu.bbs.entity.BbsReportExt> bbsReportExtSet;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsUser getProcessUser () {
		return processUser;
	}
	 ...
	 */
	public void setProcessUser (com.yhcrt.weihu.bbs.entity.BbsUser processUser) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.bbs.entity.BbsReportExt> getBbsReportExtSet () {
	 ...
	 */
	public void setBbsReportExtSet (java.util.Set<com.yhcrt.weihu.bbs.entity.BbsReportExt> bbsReportExtSet) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsReport)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsReport bbsReport = (com.yhcrt.weihu.bbs.entity.BbsReport) obj;
