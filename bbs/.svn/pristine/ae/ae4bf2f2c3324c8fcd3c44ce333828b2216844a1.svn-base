...
public abstract class BaseBbsPost  implements Serializable {
	...
	public static String UP_POST_ID = "upPost";
	...
	public BaseBbsPost (
		...
		com.yhcrt.weihu.bbs.entity.BbsConfig config,
		com.yhcrt.weihu.bbs.entity.BbsTopic topic,
		com.yhcrt.weihu.bbs.entity.BbsUser creater,
		com.yhcrt.weihu.bbs.entity.BbsPost upPost,
	...
	// one to one
	private com.yhcrt.weihu.bbs.entity.BbsPostText postText;

	// many to one
	private com.yhcrt.weihu.core.entity.CmsSite site;
	private com.yhcrt.weihu.bbs.entity.BbsConfig config;
	private com.yhcrt.weihu.bbs.entity.BbsTopic topic;
	private com.yhcrt.weihu.bbs.entity.BbsUser creater;
	private com.yhcrt.weihu.bbs.entity.BbsUser editer;
	private com.yhcrt.weihu.bbs.entity.BbsPostType postType;
	private com.yhcrt.weihu.bbs.entity.BbsPost upPost;

	// collections
	private java.util.Set<com.yhcrt.weihu.bbs.entity.BbsGrade> grade;
	private java.util.Set<com.yhcrt.weihu.bbs.entity.Attachment> attachments;
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsPostText getPostText () {
		return postText;
	}
	 ...
	 */
	public void setPostText (com.yhcrt.weihu.bbs.entity.BbsPostText postText) {
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.yhcrt.weihu.bbs.entity.BbsConfig config) {
		this.config = config;
	}
	 ...
	 */
	public com.yhcrt.weihu.bbs.entity.BbsUser getEditer () {
		return editer;
	}
	 ...
	 */
	public void setEditer (com.yhcrt.weihu.bbs.entity.BbsUser editer) {
		this.editer = editer;
	}

	public com.yhcrt.weihu.bbs.entity.BbsPostType getPostType() {
		return postType;
	}

	public void setPostType(com.yhcrt.weihu.bbs.entity.BbsPostType postType) {
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.bbs.entity.BbsGrade> getGrade () {
		return grade;
	}
	 ...
	 */
	public void setGrade (java.util.Set<com.yhcrt.weihu.bbs.entity.BbsGrade> grade) {
		this.grade = grade;
	}
	 ...
	 */
	public java.util.Set<com.yhcrt.weihu.bbs.entity.Attachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.Set<com.yhcrt.weihu.bbs.entity.Attachment> attachments) {
		this.attachments = attachments;
	}

	public com.yhcrt.weihu.bbs.entity.BbsPost getUpPost() {
		return upPost;
	}

	public void setUpPost(com.yhcrt.weihu.bbs.entity.BbsPost upPost) {
		this.upPost = upPost;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsPost)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsPost bbsPost = (com.yhcrt.weihu.bbs.entity.BbsPost) obj;
