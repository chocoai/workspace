...
import com.yhcrt.weihu.common.image.AverageImageScale;
...
public class AverageImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		AverageImageScale.resizeFix(new File(
				"test/com/yhcrt/weihu/common/util/1.bmp"), new File(
				"test/com/yhcrt/weihu/common/util/1-n-2.bmp"), 310, 310, 50, 50,
				320, 320);
