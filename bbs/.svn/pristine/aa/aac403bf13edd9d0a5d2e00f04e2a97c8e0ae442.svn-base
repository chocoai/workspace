...
public abstract class BaseBbsTopicText  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsTopicText)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsTopicText bbsTopicText = (com.yhcrt.weihu.bbs.entity.BbsTopicText) obj;
