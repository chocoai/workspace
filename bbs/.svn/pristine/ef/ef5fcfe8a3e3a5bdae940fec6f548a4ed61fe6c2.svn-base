...
public abstract class BaseBbsThirdAccount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.yhcrt.weihu.bbs.entity.BbsThirdAccount)) return false;
		else {
			com.yhcrt.weihu.bbs.entity.BbsThirdAccount cmsThirdAccount = (com.yhcrt.weihu.bbs.entity.BbsThirdAccount) obj;
