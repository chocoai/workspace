...
//	});
    ...
    $('#groupManAgeStart').datepicker({  
	    ...
	    $('#groupManAgeEnd').datepicker('setStartDate',startTime);  
	});  
	//结束时间  
	$('#groupManAgeEnd').datepicker({  
	    todayBtn : "linked",  
	    autoclose : true,  
	    todayHighlight : true,
	   // endDate : new Date()
	    ...
	    var endTime = e.date;  
	    $('#groupManAgeStart').datepicker('setEndDate',endTime);  
	});
	//组内女性年龄范围
	$('#groupWomanAgeStart').datepicker({  
		todayBtn : "linked",  
		autoclose : true,  
		todayHighlight : true,  
		endDate : new Date() 
		...
		var startTime = e.date;  
		$('#groupWomanAgeEnd').datepicker('setStartDate',startTime);  
	});  
	//结束时间  
	$('#groupWomanAgeEnd').datepicker({  
		todayBtn : "linked",  
		autoclose : true,  
		todayHighlight : true,
		// endDate : new Date()
		...
		var endTime = e.date;  
		$('#groupWomanAgeStart').datepicker('setEndDate',endTime);  
	});
