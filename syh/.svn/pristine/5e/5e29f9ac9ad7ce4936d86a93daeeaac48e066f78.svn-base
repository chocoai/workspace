   ...
   <div class="row">
      <div class="col-md-12">
          <ul class="nav nav-tabs mynav-tabs nomar_b20">
            ...
            <li role="presentation" class="active"><a href="toNuptial">重名参赛</a></li>
...
<!-- 中间内容 end -->
<script src="${contextPath}/static/localjs/warnInfo/nuptial.js?d=1"></script>
