   ...
   <div class="row">
      <div class="col-md-12">
          <ul class="nav nav-tabs mynav-tabs nomar_b20">
            ...
            <li role="presentation" class="active"><a href="toUnitNum">单位项目个数</a></li>
...
<!-- 中间内容 end -->
<script src="${contextPath}/static/localjs/warnInfo/unitNum.js?d=1"></script>
