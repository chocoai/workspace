...
<div class="content">
	<div class="row">
		<div class="col-md-12">
				<a class="btn btn-success difbtn" href="addRew" target="_self"
					target="_blank" role="button"> <i class="icon-plus"></i>
					&nbsp;新增奖惩
				</a> 
				<a id="deleleBtn" class="btn btn-warning difbtn" href="javascript:" role="button"> <i
					class="icon-bookmark-empty"></i> &nbsp;取消奖惩
				</a>
		</div>
	</div>
	<!-- 查询表单 start -->
...
<!-- 中间内容 end -->
<script src="${contextPath}/static/localjs/pubRewInfo/index.js?s=1"></script>
