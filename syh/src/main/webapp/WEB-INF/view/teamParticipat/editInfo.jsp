...
<div class="content">
  <div class="panel panel-default form-header">
    <div class="panel-heading">
	  	<h3 class="panel-title">修改参赛信息</h3>
    </div>
           ...
           <form class="form-horizontal">
               <div class="col-md-5 col-md-offset-1">
                 <div class="form-group">
                   ...
                   <div class="col-md-8">
                     <input type="text" class="form-control" id="projectName" placeholder="请输入比赛项目" disabled="disabled" value="${teamParticipat.projectManager.projectName }">
                     <input type="text" id="projectCid" value="${teamParticipat.projectCid }">
                     <input type="text"  id="unitCids" value="${teamParticipat.unitCid }">
	           		 <input type="text"  id="teamCid" value="${teamParticipat.teamCid }">
                   </div>
                 </div>
               </div>
               <div class="col-md-5">
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-md-8">
                      <div class="input-group">
						<input type="text" class="form-control" data-id=""id="unitName" placeholder="请输入单位名称" > 
...
<!-- 中间内容 end -->
<script src="${contextPath}/static/localjs/teamParticipat/editInfo.js"></script>
