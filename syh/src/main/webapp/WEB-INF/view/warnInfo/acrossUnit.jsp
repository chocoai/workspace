   ...
   <div class="row">
      <div class="col-md-12">
          <ul class="nav nav-tabs mynav-tabs nomar_b20">
            ...
            <li role="presentation"><a href="toPersonNum">个人项目个数</a></li>
            <li role="presentation" ><a href="toNuptial">重名参赛</a></li>
            <li role="presentation" class="active"><a href="toAcrossUnit">跨参赛单位参赛</a></li>
          </ul>
      </div>
   </div>
   <!-- 查询表单 strat -->
...
<!-- 中间内容 end -->
<script src="${contextPath}/static/localjs/warnInfo/acrossUnit.js"></script>
