...
package com.yhcrt.utils.validate;
...
public class RegexUtils  {
	...
	public static  boolean  ifNotUserName(String s) {
		if (s == null) {
			return true;
		}
	...
	public static boolean ifOutOfLength(String s,int minLength,
			int maxLength) {
		if (s == null) {
			return true;
		}
