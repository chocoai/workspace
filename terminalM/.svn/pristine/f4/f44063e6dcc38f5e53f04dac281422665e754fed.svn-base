...
<div class="wql_g_content wql_bge7e9eb pdb30">
    <div class="w1200">
        ...
        <div class="wql_mainBox wql_bgfff pdt15 pdlr20 wql_b_radius6 pdb40">
                    ...
                    <div class="wql_g_nav fl mgt10">
                        <div class="wql_nav01">
                            <ul class="clearfix">
                                ...
                                <li class="wql_li on"><span class="wql_bl"></span><a href="${ctx}/manage/browserWhitelistRule/list">浏览器上网设置</a></li>
            ...
            <form id="pageForm"  name="pageForm" action="${ctx}/manage/browserWhitelistRule/list" method="post">
	            <div class="mgt40">
	                <c:if test="${not empty page.totalPage && page.totalPage > 1 }">
								...
								action="${ctx}/manage/browserWhitelistRule/list"></newTag:page>
					 </c:if>
	            </div>
            </form>
        </div>
...
<div class="wql_g_artDialog dis_none">
    <div class="wql_artDialog01">
        ...
        <div class=" mgt30">
            <div class="clearfix">
                <div class="fl lh32 f18">网址列表</div>
                <div class="wql_g_btn fr">
                ...
                <li class="wql_li">
                    <div class="wql_li_box">
                        ...
                        <div class="wql_box_r">
                            ...
                            <div class="wql_tips" name="urlError"></div>
                        </div>
                    </div>
                </li>
            </ul>
	 ...
	 var dialog = art.dialog({
         ...
         ok:function(){
        	var name = $("input[name='name']").val();//分类名称
         	...
         	$.ajax({
         		type : "POST",
         		url : "${ctx}/manage/browserWhitelistRule/updateBrowserWhitelistRule",
         		traditional:true,
         		data :{
         			"name" : name,
         			"memo" : memo,
    ...
    $('.wql_addBtn').on('click',function(){
        ...
        var dialog = art.dialog({
            ...
            ok:function(){
            	...
            	$.ajax({
            		type : "POST",
            		url : "${ctx}/manage/browserWhitelistRule/saveBrowserWhitelistRule",
            		traditional:true,
            		data :{
            			"name" : name,
            			"memo" : memo,
