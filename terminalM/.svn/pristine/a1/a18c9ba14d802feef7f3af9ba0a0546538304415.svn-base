 ...
 * @date 2018年6月18日
 */
public class UploadAppInfoCommandServiceImpl implements SendDeviceCommandService {
		...
		try {
			...
			if (registerDeviceResponse != null && registerDeviceResponse.getSuccess() != false) {
				...
				if ("online".equals(status.toLowerCase())) {
					...
					deviceCommandLog.setResponseText(com.alibaba.fastjson.JSONObject.toJSONString(invokeThingServiceResponse));
	 ...
	 * @see
	 * com.whty.assis.basicdata.service.SendDeviceCommandService#sendCommand(com
	 * .whty.assis.basicdata.model.DeviceInfo, java.lang.String,
	 * java.lang.String)
	 */
	@Override
