...
public class Constants {
	...
	public static final String FAIL_CODE = "100000";// 操作失败
	...
	public static final String USESSIONID_VERIFY_FAIL = "000007";
	...
	public static final String MSG_USESSIONID_VERIFY_FAIL = "usessionid验证失败";
	...
	public static final String FAIL_LICENCE_EXPIRED_CODE = "102001";// 授权码已过期
	public static final String FAIL_LICENCE_USED_CODE = "102002";// 授权码已被使用
	public static final String FAIL_LICENCE_NOTFOUND_CODE = "102003";// 授权码未找到
	public static final String FAIL_LICENCE_NOTUSED_CODE = "102004";// 生效时间未到
	public static final String FAIL_LICENCE_CANCEL_CODE = "102005";// 授权码已注销
	...
	public static Map<String, String> resultCollectMap = new HashMap<String, String>();

	static {
		resultCollectMap.put("000000", MSG_SUCCESS_CODE);
		resultCollectMap.put("301001", MSG_USER_NOT_EXIST);
		resultCollectMap.put("301003", MSG_WRONG_PASSWARD);
		resultCollectMap.put("301004", MSG_USER_FROZEN);
		resultCollectMap.put("301005", MSG_ACCOUNT_IS_INACTIVE);
		resultCollectMap.put("301000", MSG_MANAY_USER);
		resultCollectMap.put("301999", MSG_USESSIONID_VERIFY_FAIL);
	}
	...
	// 软件使用许可验证
	public static final String LICENCE_UNBINDING = "licence未绑定";
	public static final String LICENCE_INVALIDATE = "licence注销失效";
	public static final String LICENCE_NOT_EXIT = "licence不存在";
	 ...
	 * 授权码验证
	 */
	public static final String LICENCE_WRONG_BINDING_INFO_CODE = "000001";
	public static final String LICENCE_CANCEL_CODE = "000002";
	public static final String LICENCE_UNBINDING_CODE = "000003";
	public static final String LICENCE_BINDINGED_CODE = "000004";

	public static final String LICENCE_WRONG_BINDING_INFO_MSG = "授权码绑定信息验证失败";
	public static final String LICENCE_CANCEL_MSG = "授权码已注销";
	public static final String LICENCE_UNBINDING_MSG = "授权码未绑定";
	public static final String LICENCE_BINDINGED_MSG = "授权码已绑定";
	// 激活码管理
	public static final String LICENCE_LICENCETERM = "永久";
	public static final String LICENCE_LICENCETERM_MM = "MM";
	public static final String LICENCE_LICENCETERM_DD = "DD";

	// 类容类型
	public static final String TB_BOOKPACKAGE_TYPE_INIT = "0";
	public static final String TB_BOOKPACKAGE_TYPE_UPDATE = "1";
	...
	static {
		...
		contentTypeMap.put("", "application/x-");
		...
		contentTypeMap.put("xap", "application/x-silverlight-app");
	 ...
	 * 定义系统权限管理常变量
	 */
	public static Integer SYS_STATUS_NORMAL = 0;
	public static Integer SYS_STATUS_DISNORMAL = 1;
	public static Integer SYS_BUTTONS = 10;
}
