 ...
 * @date   2018年6月19日
 */
public class CheckRuleServiceImpl implements SendDeviceCommandService{

	/* (non-Javadoc)
	 * @see com.whty.assis.basicdata.service.SendDeviceCommandService#sendCommand(com.whty.assis.basicdata.model.DeviceInfo)
	 */
	@Override
		...
		try {
			...
			if (registerDeviceResponse != null && registerDeviceResponse.getSuccess() != false) {
				...
				if ("online".equals(status.toLowerCase())) {
					...
					String action = SysConfig.getStrValue("mqtt.server.command.check_rule");
	...
	/* (non-Javadoc)
	 * @see com.whty.assis.basicdata.service.SendDeviceCommandService#sendCommand(com.whty.assis.basicdata.model.DeviceInfo, java.lang.String, java.lang.String)
	 */
	@Override
