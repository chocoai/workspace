 ...
 * @version 
 */
public class QueryThingConfigPopRequest extends RpcAcsRequest<QueryThingConfigPopResponse> {
	
	public QueryThingConfigPopRequest() {
		super("Iot", "2018-01-20", "QueryThingConfigPop");
	}
	...
	@Override
	public Class<QueryThingConfigPopResponse> getResponseClass() {
		return QueryThingConfigPopResponse.class;
	}
