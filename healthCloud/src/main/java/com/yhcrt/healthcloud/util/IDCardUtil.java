...
public final class IDCardUtil {
	 ...
	 * @throws 无效的身份证号
	 */
	public static final String fixPersonIDCodeWithCheck(String personIDCode){
	 ...
	 * @throws 身份证号出生日期段有误
	 */
	public static final String getBirthdayFromPersonIDCode(String identity){
		String id = getFixedPersonIDCode(identity);
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		try {
			Timestamp birthday = new Timestamp(new SimpleDateFormat("yyyyMMdd").parse(id.substring(6, 14)).getTime());
	 ...
	 * @throws 无效的身份证号
	 */
	public static final String getFixedPersonIDCode(String personIDCode) {
