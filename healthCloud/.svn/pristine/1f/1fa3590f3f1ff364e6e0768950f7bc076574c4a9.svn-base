package com.yhcrt.healthcloud.common.security;
 ...
 * 
 * @author 
 * @version $Id: BouncyCastleProvider.java, v 0.1 2014年3月25日 上午9:40:17
 *           Exp $
 */
...
public class BouncyCastleProvider extends Provider {
	...
	public BouncyCastleProvider() {
		...
		// these first 3 are wrong, but seem to have got around
