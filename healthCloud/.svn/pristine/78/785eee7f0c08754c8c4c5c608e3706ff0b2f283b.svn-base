		...
		<div class="row" style="padding-left: 180px; position: relative;">
			...
			<div class="col-sm-12">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<%=contextPath%>/healthService/toAddMerBG?memberId=${member.memberId }&merId=${merId }">血糖</a></li>
				...
				<div class="col-md-12">
					<h3 class="text-center">为${member.realName }录入体检报告数据(血糖)</h3>
					<form action="addMerBG" id="merBGForm" method="post" class="form-horizontal">
						<div class="modal-body">
							<input type="hidden" name="memberId" value="${member.memberId }">
							<input type="hidden" name="cid" value="${bg.cid}">
							<input type="hidden" name="merId" value="${merId }">
							
							<div class="form-group">
								<label class="col-sm-2 control-label">血糖类型</label>
								<div class="col-sm-4">
									<form:select id="bgType" path="bg.bgType" items="${applicationScope.bg_type_}" itemLabel="value" itemValue="key" cssStyle="form-control"/>
								</div>
								<label class="col-sm-2 control-label">血糖值</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="glucoseValue" name="glucoseValue" placeholder="" value="${bg.glucoseValue}" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" id="conclusion" name="conclusion" placeholder="" value="${bg.conclusion}" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="3" cols="" class="form-control" id="advice"
										name="advice" placeholder="" style="resize: none;">${bg.advice}</textarea>
								</div>
							</div>
