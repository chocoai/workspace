/*!
 * Copyright &copy; 2014-2015 <a href="https://www.3chunhui.com/webapp">webapp</a> All rights reserved.
 *
...
$.validator.setDefaults({
	...
	errorPlacement : function(a, b) {
		$("#messageBox").text("输入有误，请先更正！").removeClass("alert-success")
				.addClass("alert-error");
		if (b.is(":checkbox") || b.is(":radio")
				|| b.parent().is(".input-append")) {
...
function tableSort(f) {
	...
	var a = $.extend({}, c, f);
	var b = $(a.orderBy), e = $(a.contentTable + " th." + a.sortClass), d = b
			.val().split(" ");
	e.each(function() {
		if ($(this).hasClass(d[0])) {
			d[1] = d[1] && d[1].toUpperCase() == "DESC" ? "down" : "up";
			$(this).html(
					$(this).html() + ' <i class="icon icon-arrow-' + d[1]
							+ '"></i>')
		}
	});
	e.click(function() {
		var g = $(this).attr("class").split(" "), j = b.val().split(" ");
		...
		if (g == j[0]) {
			j = (j[1] && j[1].toUpperCase() == "DESC" ? "ASC" : "DESC");
			b.val(g + " DESC" != g + " " + j ? "" : g + " " + j)
		} else {
			b.val(g + " ASC")
		}
		a.callBack()
...
/*	// 遍历所有a标签
	$("a").each(function() {
		...
		// 改变a标签的href属性值，并且同时给a标签设增加一个href2的属性
		$(this).attr("href", "http://www.3chunhui.com").attr("href2", href2);
	});
	$("a").click(function() {
		// 点击时将href2的值提取出来赋给href
		var newhref = $(this).attr("href2");
