	...
	<div class="row-fluid" >
			...
			<div id="secondMenu">
				<ul class="nav nav-pills nav-stacked text-center">
					<shiro:hasPermission name="submenu:user:employee:list">
						<li class="active"><a href="<%=contextPath%>/employee/list" target="_self"><span>员工管理</span></a></li>
					</shiro:hasPermission>
					<shiro:hasPermission name="submenu:user:doctor:list">
						<li><a href="<%=contextPath%>/doctor/list" target="_self"><span>医师管理</span></a></li>
					</shiro:hasPermission>
		...
		<div id="right" style="padding-left: 0px; padding-right: 0px;">
			<ul class="nav nav-tabs" style="margin-bottom: 10px;">
				<li><a href="list">员工列表</a></li>
				<li class="active">
					<c:choose>
					     <c:when test="${emp.empId != null }"><a href="edit?empId=${emp.empId }">编辑员工</a></c:when>
					     <c:otherwise><a href="edit">添加员工</a></c:otherwise>
					</c:choose>
				</li>
			</ul>
			...
			<div class="col-sm-12" style="padding-right: 0px; padding-left: 0px;">
				<form class="form-horizontal pull-left form-normallr" id="empForm" method="post" action="save" enctype="multipart/form-data">
			    	<input type="hidden" id="empId" name="empId" value="${emp.empId }">
			      	<div class="form-gd-hd">员工基本信息</div>
		      		<table class="table table-bordered">
		          		<tr>
		          			<th><span style="color: red;">* 所属机构：</span></th>
		               		<td>
		                    	<input id="citySelList" type="text" class="form-control" readonly onclick="showMenuList(); return false;" value="${emp.org.orgName }"> 
								<input type="hidden" id="orgList" name="orgId" value="${emp.org.orgId }">
		               		</td>
		               		<th><span style="color: red;">* 账号：</span></th>
		               		<td>
								<input id="userCode" type="text" class="form-control" name="userCode" value="${emp.user.userCode }" >
		               		</td>
		          		</tr>
		          		<c:if test="${emp.empId == null }">
				       	...
				       	<tr>
		               		...
		               		<td>
								<input type="text" id="realName" class="form-control" name="realName" value="${emp.realName}" >
							</td>
				       	...
				       	<tr>
			                ...
			                <td>
								<input type="text" class="form-control" name="identityCard" id="identityCard" value="${emp.identityCard}" >
							</td>
							<th><span style="color: red;">* 手机号：</span></th>
		               		<td>
		               			<input type="text" name="phoneNo" class="form-control" id="phoneNo" value="${emp.phoneNo}" >
		               		</td>
				      	</tr>
				      	...
				      	<tr>
		                	...
		                	<th><span style="color: red;">* 职务：</span></th>
		               		<td>
		               			<form:select id="specialty" path="emp.specialty" items="${applicationScope.emp_specialty__}" itemLabel="value" itemValue="key" cssStyle="" class="form-control"/>
		               		</td>
			         	</tr>
		          		...
		          		<tr>
		               		<th>电子邮箱：</th>
		               		<td>
		               			<input type="text" name="email" class="form-control" id="email" value="${emp.email}">
		               		</td>
		          		</tr>
			         	<tr>
		                	<th>备注:</th>
		                	<td colspan="3">
		                		<textarea rows="3" class="form-control" name="remark" id="remark" >${emp.remark }</textarea>
		                	</td>
			         	</tr>
