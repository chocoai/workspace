...
jQuery.validator.addMethod("username", function(b, a) {
	return this.optional(a) || /^[a-zA-Z0-9][a-zA-Z0-9_]{2,15}$/.test(b)
}, "3-15位字母或数字开头，允许字母数字下划线");
...
jQuery.validator.addMethod("realName", function(b, a) {
	return this.optional(a) || /^[\u4e00-\u9fa5]{2,16}$/.test(b)
}, "姓名只能为2-16个汉字");

jQuery.validator.addMethod("areaName", function(value, element) {
    return this.optional(element) || /^[0-9A-Za-z\u4e00-\u9fa5]{2,16}$/.test(value);
}, "地区名只能为2-16个字符");

/*jQuery.validator.addMethod("officeName", function(value, element) {
    return this.optional(element) || /^[0-9A-Za-z\u4e00-\u9fa5]{2,64}$/.test(value);
}, "机构名只能为2-64个字符");*/
...
jQuery.validator.addMethod("menuName", function(value, element) {
    return this.optional(element) || /^[\u4e00-\u9fa5]{2,16}$/.test(value);
}, "菜单名只能为2-16个汉字");
...
jQuery.validator.addMethod("phone", function(c, b) {
	var a = /(^0[1-9]{1}\d{9,10}$)|(^1[3,4,5,7,8]\d{9}$)/g;
	return this.optional(b) || (a.test(c))
}, "固话为区号（3-4位）号码（7-9位），手机为:13,14,15,17,18号段");
