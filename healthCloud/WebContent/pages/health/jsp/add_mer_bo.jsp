		...
		<div class="row" style="padding-left: 180px; position: relative;">
			...
			<div class="col-sm-12">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<%=contextPath%>/healthService/toAddMerBO?memberId=${member.memberId }&merId=${merId }">血氧</a></li>
				...
				<div class="col-md-12">
					<h3 class="text-center">为${member.realName }录入体检报告数据(血氧)</h3>
					<form action="addMerBO" id="merBOForm" method="post" class="form-horizontal">
						<div class="modal-body">
							<input type="hidden" name="memberId" value="${member.memberId }">
							<input type="hidden" name="cid" value="${bo.cid}">
							<input type="hidden" name="merId" value="${merId }">
							
							<div class="form-group">
								<label class="col-sm-2 control-label">血氧值</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="boValue" name="boValue" placeholder="" value="${bo.boValue}" >
								</div>
								<label class="col-sm-2 control-label">结论</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="conclusion" name="conclusion" placeholder="" value="${bo.conclusion}" >
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="3" cols="" class="form-control" id="advice"
										name="advice" placeholder="" style="resize: none;">${bo.advice}</textarea>
								</div>
							</div>
