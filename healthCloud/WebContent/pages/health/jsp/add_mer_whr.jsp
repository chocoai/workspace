		...
		<div class="row" style="padding-left: 180px; position: relative;">
			...
			<div class="col-sm-12">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<%=contextPath%>/healthService/toAddMerWHR?memberId=${member.memberId }&merId=${merId }">腰臀比</a></li>
				</ul>
				<!-- tab end -->
				
				<div class="col-md-12">
					<h3 class="text-center">为${member.realName }录入体检报告数据(腰臀比)</h3>
					<form action="addMerWHR" id="merWHRForm" method="post" class="form-horizontal">
						<div class="modal-body">
							<input type="hidden" name="memberId" value="${member.memberId }">
							<input type="hidden" name="cid" value="${whr.cid}">
							<input type="hidden" name="merId" value="${merId }">
							
							<div class="form-group">
								<label class="col-sm-2 control-label">腰围</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="waistline" name="waistline" placeholder="" value="${whr.waistline}" >
								</div>
								<label class="col-sm-2 control-label">臀围</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="hipline" name="hipline" placeholder="" value="${whr.hipline}" >
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 control-label">腰臀比</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="waistHipRatio" name="waistHipRatio" placeholder="" value="${whr.waistHipRatio}" >
								</div>
								<label class="col-sm-2 control-label">结论</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="conclusion" name="conclusion" placeholder="" value="${whr.conclusion}" >
								</div>
							</div>							
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="3" cols="" class="form-control" id="advice"
										name="advice" placeholder="" style="resize: none;">${whr.advice}</textarea>
								</div>
							</div>
