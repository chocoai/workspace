	...
	<div class="row-fluid" >
		...
		<div id="right" style="padding-left: 0px;padding-right: 0px;">
			<ul class="nav nav-tabs">
				<li><a href="../employee/list?status=1">被禁用的员工</a></li>
				<li class="active"><a href="list?status=1">被禁用的医师</a></li>
			</ul>
...
<script type="text/javascript">
	...
	var allColumns = [{
		...
		"data" : "",
		"render" : function(data, type, row, meta) {
			return "<a class='btn btn-info btn-xs' href='javascript:;' onclick='recover("+row.docId+")'>恢复</a>";
		}
	...
	function recover(docId){
    	layer.msg('该操作将使医师账号可用，是否继续?', {time: 0, btn: ['继续', '点错了'], yes: function(index){
    		layer.close(index);
    		$.ajax({
	        	type: "post",
	            url: "recover",
