	...
	<div class="row-fluid" >
			...
			<div id="secondMenu">
				<ul class="nav nav-pills nav-stacked text-center">
					...
					<shiro:hasPermission name="submenu:user:disable:list">
						<li class="active"><a href="<%=contextPath%>/employee/list?status=1" target="_self"><span>禁用列表</span></a></li>
					</shiro:hasPermission>
				</ul>
			</div>
		</div>
		...
		<div id="right" style="padding-top: 0px;padding-left: 0px;padding-right: 0px;margin-left: 0px;margin-right: 0px;">
			<ul class="nav nav-tabs">
				<li class="active"><a href="list?status=1">被禁用的员工</a></li>
				<li><a href="../doctor/list?status=1">被禁用的医师</a></li>
			</ul>
			
			<div class="col-md-12" id="modalBodyList" style="padding-right: 0px;padding-top: 0px;padding-left: 0px;">
				<ol id="subDiv" class="breadcrumb">
					<form id="subForm" class="form-inline">
						...
						&nbsp;&nbsp;
						<button class="btn btn-primary" type="button" onclick="sub(1,1)">查找</button>
					</form>
				</ol>
			</div>
...
<script type="text/javascript">
	...
	var allColumns = [{
		...
		"data" : "",
		"render" : function(data, type, row, meta) {
			return "<a class='btn btn-info btn-xs' href='javascript:;' onclick='recover("+row.empId+")'>恢复</a>";
		}
	}];
	...
	function recover(empId){
    	layer.msg('该操作将使员工账号可用，是否继续?', {time: 0, btn: ['继续', '点错了'], yes: function(index){
    		layer.close(index);
	        $.ajax({
	        	type: "post",
	            url: "recover",
